...
VL_INLINE_OPT void VQueuePipeTester::_sequent__TOP__1(VQueuePipeTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/2020030621373616320622420557370503/QueuePipeTester.v:502
    if (vlTOPp->reset) {
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
				   | ((2U == ((((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_1) 
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/2020030621373616320622420557370503/QueuePipeTester.v",541,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->QueuePipeTester__DOT___T_29) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/2020030621373616320622420557370503/QueuePipeTester.v",552,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/2020030621373616320622420557370503/QueuePipeTester.v:286
    __Vdly__QueuePipeTester__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/2020030621373616320622420557370503/QueuePipeTester.v:92
    if (vlTOPp->reset) {
    ...
    vlTOPp->QueuePipeTester__DOT__q__DOT___T_12 = (1U 
						   & ((IData)(1U) 
						      + (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__value)));
    vlTOPp->QueuePipeTester__DOT__q__DOT___T_14 = (1U 
						   & ((IData)(1U) 
						      + (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__value_1)));
...
void VQueuePipeTester::_ctor_var_reset() {
    ...
    QueuePipeTester__DOT__q__DOT__value = VL_RAND_RESET_I(1);
    QueuePipeTester__DOT__q__DOT__value_1 = VL_RAND_RESET_I(1);
    ...
    QueuePipeTester__DOT__q__DOT___T_12 = VL_RAND_RESET_I(1);
    QueuePipeTester__DOT__q__DOT___T_14 = VL_RAND_RESET_I(1);
