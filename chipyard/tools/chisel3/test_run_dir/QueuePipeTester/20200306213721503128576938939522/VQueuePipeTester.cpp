...
VL_INLINE_OPT void VQueuePipeTester::_sequent__TOP__1(VQueuePipeTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/20200306213721503128576938939522/QueuePipeTester.v:458
    if (vlTOPp->reset) {
	...
	if ((((IData)(vlTOPp->QueuePipeTester__DOT___T_15) 
	      >> 0xeU) & (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_1))) {
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
				   | ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_1) 
				      & (~ ((IData)(vlTOPp->QueuePipeTester__DOT___T_15) 
					    >> 0xeU)))) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: QueuePipeTester.v:497: Assertion failed in %NQueuePipeTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/20200306213721503128576938939522/QueuePipeTester.v",497,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->QueuePipeTester__DOT___T_29) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/20200306213721503128576938939522/QueuePipeTester.v",508,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/20200306213721503128576938939522/QueuePipeTester.v:242
    __Vdly__QueuePipeTester__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/20200306213721503128576938939522/QueuePipeTester.v:61
    if (vlTOPp->reset) {
	vlTOPp->QueuePipeTester__DOT__q__DOT___T_1 = 0U;
    } else {
	if (vlTOPp->QueuePipeTester__DOT__q__DOT___T_11) {
    ...
    vlTOPp->QueuePipeTester__DOT__q__DOT___T_6 = ((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
						  & (0x14U 
						     > (IData)(vlTOPp->QueuePipeTester__DOT__value)));
    vlTOPp->QueuePipeTester__DOT__q__DOT___T_11 = ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_6) 
						   != 
						   (((IData)(vlTOPp->QueuePipeTester__DOT___T_15) 
						     >> 0xeU) 
						    & (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_1)));
...
void VQueuePipeTester::_ctor_var_reset() {
    ...
    QueuePipeTester__DOT__q__DOT___T_11 = VL_RAND_RESET_I(1);
