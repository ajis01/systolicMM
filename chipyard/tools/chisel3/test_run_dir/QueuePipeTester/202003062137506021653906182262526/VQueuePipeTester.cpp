...
VL_INLINE_OPT void VQueuePipeTester::_sequent__TOP__1(VQueuePipeTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/202003062137506021653906182262526/QueuePipeTester.v:516
    if (vlTOPp->reset) {
	...
	if ((1U & (((IData)(vlTOPp->QueuePipeTester__DOT___T_15) 
		    >> 0xaU) & (~ (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_4))))) {
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
				   | ((3U == (3U & 
				      ...
				      & (~ ((IData)(vlTOPp->QueuePipeTester__DOT___T_15) 
					    >> 0xaU)))) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: QueuePipeTester.v:555: Assertion failed in %NQueuePipeTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/202003062137506021653906182262526/QueuePipeTester.v",555,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->QueuePipeTester__DOT___T_29) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/202003062137506021653906182262526/QueuePipeTester.v",566,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/202003062137506021653906182262526/QueuePipeTester.v:300
    __Vdly__QueuePipeTester__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/202003062137506021653906182262526/QueuePipeTester.v:98
    if (vlTOPp->reset) {
	...
	if (vlTOPp->QueuePipeTester__DOT__q__DOT___T_8) {
		...
		= ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__wrap_1)
		    ? 0U : (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_14));
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/202003062137506021653906182262526/QueuePipeTester.v:98
    if (vlTOPp->reset) {
	...
	if (vlTOPp->QueuePipeTester__DOT__q__DOT___T_6) {
		...
		= ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__wrap)
		    ? 0U : (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_12));
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueuePipeTester/202003062137506021653906182262526/QueuePipeTester.v:300
	...
	(2U == (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__value_1));
    ...
    vlTOPp->QueuePipeTester__DOT__q__DOT___T_12 = (3U 
						   & ((IData)(1U) 
						      + (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__value)));
    vlTOPp->QueuePipeTester__DOT__q__DOT___T_20 = (3U 
						   & ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__value) 
						      - (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__value_1)));
	...
	(1U & (((IData)(vlTOPp->QueuePipeTester__DOT___T_15) 
		>> 0xaU) | (~ ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_2) 
			       & (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___T_1)))));
...
void VQueuePipeTester::_ctor_var_reset() {
    ...
    QueuePipeTester__DOT__q__DOT__wrap = VL_RAND_RESET_I(1);
    QueuePipeTester__DOT__q__DOT___T_12 = VL_RAND_RESET_I(2);
    QueuePipeTester__DOT__q__DOT__wrap_1 = VL_RAND_RESET_I(1);
    QueuePipeTester__DOT__q__DOT___T_14 = VL_RAND_RESET_I(2);
    QueuePipeTester__DOT__q__DOT___T_20 = VL_RAND_RESET_I(2);
