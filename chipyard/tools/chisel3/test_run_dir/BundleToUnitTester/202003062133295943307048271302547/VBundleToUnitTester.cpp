...
VL_INLINE_OPT void VBundleToUnitTester::_sequent__TOP__1(VBundleToUnitTester__Syms* __restrict vlSymsp) {
    ...
    VBundleToUnitTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/BundleToUnitTester/202003062133295943307048271302547/BundleToUnitTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/BundleToUnitTester/202003062133295943307048271302547/BundleToUnitTester.v",13,"");
	}
    }
}
