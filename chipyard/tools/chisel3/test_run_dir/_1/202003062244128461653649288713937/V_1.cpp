...
VL_INLINE_OPT void V_1::_sequent__TOP__1(V_1__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_1/202003062244128461653649288713937/_1.v:47
    __Vdly___1__DOT__value = ((~ (IData)(vlTOPp->reset)) 
			      & (IData)(vlTOPp->_1__DOT___T_4));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->_1__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_1/202003062244128461653649288713937/_1.v",58,"");
	}
    }
