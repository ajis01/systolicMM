...
VL_INLINE_OPT void VFailingAssertTester::_sequent__TOP__1(VFailingAssertTester__Syms* __restrict vlSymsp) {
    ...
    VFailingAssertTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/FailingAssertTester/2020030622452616168385784188056863/FailingAssertTester.v:51
    if (vlTOPp->reset) {
	...
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/FailingAssertTester/2020030622452616168385784188056863/FailingAssertTester.v",75,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->FailingAssertTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/FailingAssertTester/2020030622452616168385784188056863/FailingAssertTester.v",86,"");
	}
    }
