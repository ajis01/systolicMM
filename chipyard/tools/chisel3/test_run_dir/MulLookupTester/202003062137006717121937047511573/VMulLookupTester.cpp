...
VL_INLINE_OPT void VMulLookupTester::_sequent__TOP__1(VMulLookupTester__Syms* __restrict vlSymsp) {
    ...
    VMulLookupTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MulLookupTester/202003062137006717121937047511573/MulLookupTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MulLookupTester/202003062137006717121937047511573/MulLookupTester.v",13,"");
	}
    }
}
