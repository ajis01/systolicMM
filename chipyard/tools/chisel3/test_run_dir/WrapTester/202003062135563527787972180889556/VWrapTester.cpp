...
VL_INLINE_OPT void VWrapTester::_sequent__TOP__1(VWrapTester__Syms* __restrict vlSymsp) {
    ...
    VWrapTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/202003062135563527787972180889556/WrapTester.v:53
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->WrapTester__DOT__wrap) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/202003062135563527787972180889556/WrapTester.v",79,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->WrapTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/202003062135563527787972180889556/WrapTester.v",90,"");
	}
    }
