...
VL_INLINE_OPT void VWrapTester::_sequent__TOP__1(VWrapTester__Syms* __restrict vlSymsp) {
    ...
    VWrapTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG8(__Vdly__WrapTester__DOT__value,0,0);
    // Body
    __Vdly__WrapTester__DOT__value = vlTOPp->WrapTester__DOT__value;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/2020030621354910656668963477223017/WrapTester.v:51
    __Vdly__WrapTester__DOT__value = ((~ (IData)(vlTOPp->reset)) 
				      & (IData)(vlTOPp->WrapTester__DOT___T_2));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->WrapTester__DOT__value) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->WrapTester__DOT__value) 
			 & (~ (IData)(vlTOPp->WrapTester__DOT___T_5))))) {
	    VL_WRITEF("[%0t] %%Error: WrapTester.v:73: Assertion failed in %NWrapTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/2020030621354910656668963477223017/WrapTester.v",73,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->WrapTester__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/2020030621354910656668963477223017/WrapTester.v",84,"");
	}
    }
    vlTOPp->WrapTester__DOT__value = __Vdly__WrapTester__DOT__value;
    vlTOPp->WrapTester__DOT___T_2 = (1U & ((IData)(1U) 
...
void VWrapTester::_settle__TOP__2(VWrapTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->WrapTester__DOT___T_2 = (1U & ((IData)(1U) 
					   + (IData)(vlTOPp->WrapTester__DOT__value)));
    vlTOPp->WrapTester__DOT___T_5 = ((IData)(vlTOPp->WrapTester__DOT__value) 
				     | (IData)(vlTOPp->reset));
}
...
void VWrapTester::_ctor_var_reset() {
    ...
    WrapTester__DOT__value = VL_RAND_RESET_I(1);
    WrapTester__DOT___T_2 = VL_RAND_RESET_I(1);
