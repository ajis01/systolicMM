...
VL_INLINE_OPT void VWrapTester::_sequent__TOP__1(VWrapTester__Syms* __restrict vlSymsp) {
    ...
    VWrapTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/2020030622462012959690474891442665/WrapTester.v:53
    vlTOPp->WrapTester__DOT__value = ((IData)(vlTOPp->reset)
				       ? 0U : ((IData)(vlTOPp->WrapTester__DOT__wrap)
					        ? 0U
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->WrapTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->WrapTester__DOT___T_5))))) {
	    VL_WRITEF("[%0t] %%Error: WrapTester.v:79: Assertion failed in %NWrapTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/2020030622462012959690474891442665/WrapTester.v",79,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->WrapTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WrapTester/2020030622462012959690474891442665/WrapTester.v",90,"");
	}
    }
    vlTOPp->WrapTester__DOT__wrap = (2U == (IData)(vlTOPp->WrapTester__DOT__value));
...
void VWrapTester::_settle__TOP__2(VWrapTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->WrapTester__DOT___T_2 = (3U & ((IData)(1U) 
					   + (IData)(vlTOPp->WrapTester__DOT__value)));
    vlTOPp->WrapTester__DOT___T_5 = ((2U == (IData)(vlTOPp->WrapTester__DOT__value)) 
				     | (IData)(vlTOPp->reset));
}
