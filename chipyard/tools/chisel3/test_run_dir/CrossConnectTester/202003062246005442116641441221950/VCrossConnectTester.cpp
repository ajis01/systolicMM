...
VL_INLINE_OPT void VCrossConnectTester::_sequent__TOP__1(VCrossConnectTester__Syms* __restrict vlSymsp) {
    ...
    VCrossConnectTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CrossConnectTester/202003062246005442116641441221950/CrossConnectTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CrossConnectTester/202003062246005442116641441221950/CrossConnectTester.v",13,"");
	}
    }
}
