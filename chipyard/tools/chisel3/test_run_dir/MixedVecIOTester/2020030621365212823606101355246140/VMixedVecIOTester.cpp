...
VL_INLINE_OPT void VMixedVecIOTester::_sequent__TOP__1(VMixedVecIOTester__Syms* __restrict vlSymsp) {
    ...
    VMixedVecIOTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecIOTester/2020030621365212823606101355246140/MixedVecIOTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecIOTester/2020030621365212823606101355246140/MixedVecIOTester.v",13,"");
	}
    }
}
