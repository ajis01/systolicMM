...
VL_INLINE_OPT void VCountTester::_sequent__TOP__1(VCountTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030621341214840951619881604757/CountTester.v:47
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->CountTester__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030621341214840951619881604757/CountTester.v",58,"");
	}
    }
