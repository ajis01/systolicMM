...
void VCountTester::traceInitThis__1(VCountTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->declBit  (c+1,"CountTester value",-1);
	// Tracing: CountTester _RAND_0 // Ignored: Inlined leading underscore at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030621341214840951619881604757/CountTester.v:6
	// Tracing: CountTester _T_2 // Ignored: Inlined leading underscore at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030621341214840951619881604757/CountTester.v:7
	// Tracing: CountTester _T_5 // Ignored: Inlined leading underscore at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030621341214840951619881604757/CountTester.v:8
    }
}
...
void VCountTester::traceFullThis__1(VCountTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->fullBit  (c+1,(vlTOPp->CountTester__DOT__value));
