...
VL_INLINE_OPT void VCountTester::_sequent__TOP__1(VCountTester__Syms* __restrict vlSymsp) {
    ...
    VCountTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030622443711762402739717994934/CountTester.v:49
    vlTOPp->CountTester__DOT__value = ((IData)(vlTOPp->reset)
				        ? 0U : ((IData)(vlTOPp->CountTester__DOT___T)
						 ? 0U
						 : (IData)(vlTOPp->CountTester__DOT___T_2)));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->CountTester__DOT___T) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030622443711762402739717994934/CountTester.v",64,"");
	}
    }
    vlTOPp->CountTester__DOT___T = (2U == (IData)(vlTOPp->CountTester__DOT__value));
