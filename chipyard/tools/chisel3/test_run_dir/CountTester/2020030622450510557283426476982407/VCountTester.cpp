...
VL_INLINE_OPT void VCountTester::_sequent__TOP__1(VCountTester__Syms* __restrict vlSymsp) {
    ...
    VCountTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG8(__Vdly__CountTester__DOT__value,0,0);
    // Body
    __Vdly__CountTester__DOT__value = vlTOPp->CountTester__DOT__value;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030622450510557283426476982407/CountTester.v:47
    __Vdly__CountTester__DOT__value = ((~ (IData)(vlTOPp->reset)) 
				       & (IData)(vlTOPp->CountTester__DOT___T_2));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->CountTester__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountTester/2020030622450510557283426476982407/CountTester.v",58,"");
	}
    }
    vlTOPp->CountTester__DOT__value = __Vdly__CountTester__DOT__value;
    vlTOPp->CountTester__DOT___T_2 = (1U & ((IData)(1U) 
...
void VCountTester::_ctor_var_reset() {
    ...
    CountTester__DOT__value = VL_RAND_RESET_I(1);
    CountTester__DOT___T_2 = VL_RAND_RESET_I(1);
