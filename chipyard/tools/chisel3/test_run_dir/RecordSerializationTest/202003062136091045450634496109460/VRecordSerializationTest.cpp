...
VL_INLINE_OPT void VRecordSerializationTest::_sequent__TOP__1(VRecordSerializationTest__Syms* __restrict vlSymsp) {
    ...
    VRecordSerializationTest* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordSerializationTest/202003062136091045450634496109460/RecordSerializationTest.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordSerializationTest/202003062136091045450634496109460/RecordSerializationTest.v",13,"");
	}
    }
}
