...
VL_INLINE_OPT void VStopTester::_sequent__TOP__1(VStopTester__Syms* __restrict vlSymsp) {
    ...
    VStopTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StopTester/2020030622453314989968293657205504/StopTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StopTester/2020030622453314989968293657205504/StopTester.v",13,"");
	}
    }
}
