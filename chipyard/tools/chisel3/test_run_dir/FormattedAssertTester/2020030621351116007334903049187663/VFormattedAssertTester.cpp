...
VL_INLINE_OPT void VFormattedAssertTester::_sequent__TOP__1(VFormattedAssertTester__Syms* __restrict vlSymsp) {
    ...
    VFormattedAssertTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/FormattedAssertTester/2020030621351116007334903049187663/FormattedAssertTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/FormattedAssertTester/2020030621351116007334903049187663/FormattedAssertTester.v",13,"");
	}
    }
}
