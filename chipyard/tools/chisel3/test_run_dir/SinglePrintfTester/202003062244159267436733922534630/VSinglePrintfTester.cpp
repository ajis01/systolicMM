...
VL_INLINE_OPT void VSinglePrintfTester::_sequent__TOP__1(VSinglePrintfTester__Syms* __restrict vlSymsp) {
    ...
    VSinglePrintfTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/SinglePrintfTester/202003062244159267436733922534630/SinglePrintfTester.v:7
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/SinglePrintfTester/202003062244159267436733922534630/SinglePrintfTester.v",24,"");
	}
    }
}
