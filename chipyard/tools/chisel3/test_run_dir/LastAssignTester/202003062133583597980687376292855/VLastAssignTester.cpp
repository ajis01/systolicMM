...
VL_INLINE_OPT void VLastAssignTester::_sequent__TOP__1(VLastAssignTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LastAssignTester/202003062133583597980687376292855/LastAssignTester.v:47
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LastAssignTester__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LastAssignTester/202003062133583597980687376292855/LastAssignTester.v",58,"");
	}
    }
