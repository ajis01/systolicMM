...
VL_INLINE_OPT void VShiftTester::_sequent__TOP__1(VShiftTester__Syms* __restrict vlSymsp) {
    ...
    VShiftTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG8(__Vdly__ShiftTester__DOT__value,0,0);
    // Body
    __Vdly__ShiftTester__DOT__value = vlTOPp->ShiftTester__DOT__value;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/2020030621363110248892144263420639/ShiftTester.v:69
    __Vdly__ShiftTester__DOT__value = ((~ (IData)(vlTOPp->reset)) 
				       & (IData)(vlTOPp->ShiftTester__DOT___T_2));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftTester__DOT__value) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftTester__DOT__value) 
			 & (~ ((0x17U == (IData)(vlTOPp->ShiftTester__DOT__sr)) 
			       | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: ShiftTester.v:91: Assertion failed in %NShiftTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/2020030621363110248892144263420639/ShiftTester.v",91,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftTester__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/2020030621363110248892144263420639/ShiftTester.v",102,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/2020030621363110248892144263420639/ShiftTester.v:69
    vlTOPp->ShiftTester__DOT__sr = vlTOPp->ShiftTester__DOT___T_5;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/2020030621363110248892144263420639/ShiftTester.v:69
    vlTOPp->ShiftTester__DOT___T_5 = (0x1fU & ((IData)(0x17U) 
					       + (IData)(vlTOPp->ShiftTester__DOT__value)));
    vlTOPp->ShiftTester__DOT__value = __Vdly__ShiftTester__DOT__value;
    vlTOPp->ShiftTester__DOT___T_2 = (1U & ((IData)(1U) 
					    + (IData)(vlTOPp->ShiftTester__DOT__value)));
}
...
void VShiftTester::_ctor_var_reset() {
    ...
    ShiftTester__DOT__value = VL_RAND_RESET_I(1);
    ShiftTester__DOT___T_2 = VL_RAND_RESET_I(1);
