...
VL_MODULE(VShiftTester) {
  public:
    ...
    VL_SIG8(ShiftTester__DOT__value,1,0);
    VL_SIG8(ShiftTester__DOT__done,0,0);
    VL_SIG8(ShiftTester__DOT___T_2,1,0);
    VL_SIG8(ShiftTester__DOT___T_5,4,0);
    VL_SIG8(ShiftTester__DOT___T_6,4,0);
    VL_SIG8(ShiftTester__DOT___T_7,4,0);
