...
VL_INLINE_OPT void VShiftTester::_sequent__TOP__1(VShiftTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/202003062246486657686649548903227/ShiftTester.v:77
    __Vdly__ShiftTester__DOT__sr = vlTOPp->ShiftTester__DOT___T_6;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/202003062246486657686649548903227/ShiftTester.v:77
    ...
    vlTOPp->ShiftTester__DOT__value = ((IData)(vlTOPp->reset)
				        ? 0U : ((IData)(vlTOPp->ShiftTester__DOT__done)
						 ? 0U
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftTester__DOT__done) 
			 & (~ ((0x17U == (IData)(vlTOPp->ShiftTester__DOT__sr)) 
			       | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: ShiftTester.v:104: Assertion failed in %NShiftTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/202003062246486657686649548903227/ShiftTester.v",104,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftTester/202003062246486657686649548903227/ShiftTester.v",115,"");
	}
    }
    vlTOPp->ShiftTester__DOT__sr = __Vdly__ShiftTester__DOT__sr;
    vlTOPp->ShiftTester__DOT__done = (2U == (IData)(vlTOPp->ShiftTester__DOT__value));
