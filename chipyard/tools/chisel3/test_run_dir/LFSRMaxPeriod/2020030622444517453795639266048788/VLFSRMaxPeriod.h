...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT__rv,2,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__seed,2,0);
    VL_SIG8(LFSRMaxPeriod__DOT__value,2,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_2,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_4,2,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_6,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_8,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__last,2,0);
