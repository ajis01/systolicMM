...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT__rv,4,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__seed,4,0);
    VL_SIG8(LFSRMaxPeriod__DOT__value,4,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_4,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_6,4,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_8,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_10,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__last,4,0);
