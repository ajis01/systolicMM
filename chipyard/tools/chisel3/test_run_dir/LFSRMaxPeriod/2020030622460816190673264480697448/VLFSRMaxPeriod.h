...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG16(LFSRMaxPeriod__DOT__rv,9,0);
    VL_SIG16(LFSRMaxPeriod__DOT__seed,9,0);
    VL_SIG16(LFSRMaxPeriod__DOT__value,9,0);
    VL_SIG16(LFSRMaxPeriod__DOT___T_11,9,0);
    VL_SIG16(LFSRMaxPeriod__DOT__last,9,0);
