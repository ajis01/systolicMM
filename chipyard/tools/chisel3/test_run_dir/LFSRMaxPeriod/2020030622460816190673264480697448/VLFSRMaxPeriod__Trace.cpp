...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),10);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+12,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+13,(vlTOPp->LFSRMaxPeriod__DOT__seed),10);
	vcdp->chgBus  (c+14,(vlTOPp->LFSRMaxPeriod__DOT__value),10);
	vcdp->chgBit  (c+15,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0x3feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+16,(vlTOPp->LFSRMaxPeriod__DOT__last),10);
    }
}
