...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT__rv,7,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__seed,7,0);
    VL_SIG8(LFSRMaxPeriod__DOT__value,7,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_7,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_9,7,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_11,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_13,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__last,7,0);
