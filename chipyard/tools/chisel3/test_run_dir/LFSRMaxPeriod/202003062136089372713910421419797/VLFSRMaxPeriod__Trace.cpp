...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),15);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+17,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+18,(vlTOPp->LFSRMaxPeriod__DOT__seed),15);
	vcdp->chgBus  (c+19,(vlTOPp->LFSRMaxPeriod__DOT__value),15);
	vcdp->chgBit  (c+20,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0x7ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+21,(vlTOPp->LFSRMaxPeriod__DOT__last),15);
    }
}
