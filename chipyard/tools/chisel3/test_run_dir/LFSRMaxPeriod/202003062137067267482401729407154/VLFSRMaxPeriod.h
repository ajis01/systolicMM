...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT__rv,5,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__seed,5,0);
    VL_SIG8(LFSRMaxPeriod__DOT__value,5,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_5,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_7,5,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_9,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_11,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__last,5,0);
