...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT___T_11,0,0);
    ...
    VL_SIG16(LFSRMaxPeriod__DOT__rv,11,0);
    VL_SIG16(LFSRMaxPeriod__DOT__seed,11,0);
    VL_SIG16(LFSRMaxPeriod__DOT__value,11,0);
    VL_SIG16(LFSRMaxPeriod__DOT___T_13,11,0);
    VL_SIG16(LFSRMaxPeriod__DOT__last,11,0);
