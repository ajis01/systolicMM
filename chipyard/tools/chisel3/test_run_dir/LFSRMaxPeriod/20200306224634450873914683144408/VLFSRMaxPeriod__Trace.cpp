...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),13);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+15,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+16,(vlTOPp->LFSRMaxPeriod__DOT__seed),13);
	vcdp->chgBus  (c+17,(vlTOPp->LFSRMaxPeriod__DOT__value),13);
	vcdp->chgBit  (c+18,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0x1ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+19,(vlTOPp->LFSRMaxPeriod__DOT__last),13);
    }
}
