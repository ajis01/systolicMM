...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622445215278051585626035347/LFSRMaxPeriod.v:198
    if ((1U & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)))) {
	vlTOPp->LFSRMaxPeriod__DOT__seed = vlTOPp->LFSRMaxPeriod__DOT__rv;
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622445215278051585626035347/LFSRMaxPeriod.v:72
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2 
	...
	if (vlTOPp->LFSRMaxPeriod__DOT__started) {
	    vlTOPp->LFSRMaxPeriod__DOT__value = ((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_3)
						  ? 0U
						  : (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_5));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_7) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_7) 
			 & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_9))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:233: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622445215278051585626035347/LFSRMaxPeriod.v",233,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_7) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622445215278051585626035347/LFSRMaxPeriod.v",244,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
	    ...
	    VL_FWRITEF(0x80000002U,"Assertion failed: LFSR last value (0b%b) was equal to current value (0b%b)\n    at LFSR16.scala:61 chisel3.assert(rv =/= last, \"LFSR last value (0b%%b) was equal to current value (0b%%b)\", rv, last)\n",
		       4,vlTOPp->LFSRMaxPeriod__DOT__rv,
		       4,(IData)(vlTOPp->LFSRMaxPeriod__DOT__last));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
				   != (IData)(vlTOPp->LFSRMaxPeriod__DOT__last)) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:266: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622445215278051585626035347/LFSRMaxPeriod.v",266,"");
	}
    }
    vlTOPp->LFSRMaxPeriod__DOT__started = __Vdly__LFSRMaxPeriod__DOT__started;
    vlTOPp->LFSRMaxPeriod__DOT___T_3 = (0xeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value));
    vlTOPp->LFSRMaxPeriod__DOT___T_5 = (0xfU & ((IData)(1U) 
						+ (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622445215278051585626035347/LFSRMaxPeriod.v:198
    vlTOPp->LFSRMaxPeriod__DOT__last = ((((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_3) 
					  << 3U) | 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2 
	= __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2;
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_3) 
				       << 3U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2) 
						  << 2U) 
						 | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1) 
						     << 1U) 
						    | (IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_0))));
    vlTOPp->LFSRMaxPeriod__DOT___T_7 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
...
void VLFSRMaxPeriod::_settle__TOP__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->LFSRMaxPeriod__DOT___T_5 = (0xfU & ((IData)(1U) 
						+ (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    vlTOPp->LFSRMaxPeriod__DOT___T_9 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
...
void VLFSRMaxPeriod::_ctor_var_reset() {
    ...
    LFSRMaxPeriod__DOT__rv = VL_RAND_RESET_I(4);
    LFSRMaxPeriod__DOT__started = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__seed = VL_RAND_RESET_I(4);
    LFSRMaxPeriod__DOT__value = VL_RAND_RESET_I(4);
    LFSRMaxPeriod__DOT___T_3 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_5 = VL_RAND_RESET_I(4);
    LFSRMaxPeriod__DOT___T_7 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_9 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__last = VL_RAND_RESET_I(4);
