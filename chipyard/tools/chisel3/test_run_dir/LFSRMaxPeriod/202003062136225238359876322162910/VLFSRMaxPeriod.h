...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT___T_6,7,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_15,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_19,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_21,0,0);
    ...
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_5,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_7,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_8,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_9,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_10,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_11,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_12,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_13,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_14,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_15,0,0);
    VL_SIG16(LFSRMaxPeriod__DOT__rv,15,0);
    VL_SIG16(LFSRMaxPeriod__DOT__seed,15,0);
    VL_SIG16(LFSRMaxPeriod__DOT__value,15,0);
    VL_SIG16(LFSRMaxPeriod__DOT___T_17,15,0);
    VL_SIG16(LFSRMaxPeriod__DOT__last,15,0);
