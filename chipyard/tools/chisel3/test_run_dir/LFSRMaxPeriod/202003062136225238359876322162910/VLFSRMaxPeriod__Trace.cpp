...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),16);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+11,(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_9));
	vcdp->chgBit  (c+12,(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_10));
	vcdp->chgBit  (c+13,(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_11));
	vcdp->chgBit  (c+14,(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_12));
	vcdp->chgBit  (c+15,(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_13));
	vcdp->chgBit  (c+16,(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_14));
	vcdp->chgBit  (c+17,(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_15));
	vcdp->chgBit  (c+18,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+19,(vlTOPp->LFSRMaxPeriod__DOT__seed),16);
	vcdp->chgBus  (c+20,(vlTOPp->LFSRMaxPeriod__DOT__value),16);
	vcdp->chgBit  (c+21,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0xfffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+22,(vlTOPp->LFSRMaxPeriod__DOT__last),16);
    }
}
