...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),4);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+6,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+7,(vlTOPp->LFSRMaxPeriod__DOT__seed),4);
	vcdp->chgBus  (c+8,(vlTOPp->LFSRMaxPeriod__DOT__value),4);
	vcdp->chgBit  (c+9,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			     & (0xeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+10,(vlTOPp->LFSRMaxPeriod__DOT__last),4);
    }
}
