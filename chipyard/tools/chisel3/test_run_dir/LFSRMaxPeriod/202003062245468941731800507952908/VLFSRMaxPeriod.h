...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT___T_8,0,0);
    ...
    VL_SIG16(LFSRMaxPeriod__DOT__rv,8,0);
    VL_SIG16(LFSRMaxPeriod__DOT__seed,8,0);
    VL_SIG16(LFSRMaxPeriod__DOT__value,8,0);
    VL_SIG16(LFSRMaxPeriod__DOT___T_10,8,0);
    VL_SIG16(LFSRMaxPeriod__DOT__last,8,0);
