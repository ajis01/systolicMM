...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062136382410362379240109517/LFSRMaxPeriod.v:183
    if ((1U & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)))) {
	vlTOPp->LFSRMaxPeriod__DOT__seed = vlTOPp->LFSRMaxPeriod__DOT__rv;
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062136382410362379240109517/LFSRMaxPeriod.v:66
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1 
	...
	if (vlTOPp->LFSRMaxPeriod__DOT__started) {
	    vlTOPp->LFSRMaxPeriod__DOT__value = ((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_2)
						  ? 0U
						  : (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_4));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_6) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_6) 
			 & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_8))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:218: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062136382410362379240109517/LFSRMaxPeriod.v",218,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_6) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062136382410362379240109517/LFSRMaxPeriod.v",229,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
	    ...
	    VL_FWRITEF(0x80000002U,"Assertion failed: LFSR last value (0b%b) was equal to current value (0b%b)\n    at LFSR16.scala:61 chisel3.assert(rv =/= last, \"LFSR last value (0b%%b) was equal to current value (0b%%b)\", rv, last)\n",
		       3,vlTOPp->LFSRMaxPeriod__DOT__rv,
		       3,(IData)(vlTOPp->LFSRMaxPeriod__DOT__last));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
				   != (IData)(vlTOPp->LFSRMaxPeriod__DOT__last)) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:251: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062136382410362379240109517/LFSRMaxPeriod.v",251,"");
	}
    }
    vlTOPp->LFSRMaxPeriod__DOT__started = __Vdly__LFSRMaxPeriod__DOT__started;
    vlTOPp->LFSRMaxPeriod__DOT___T_2 = (6U == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value));
    vlTOPp->LFSRMaxPeriod__DOT___T_4 = (7U & ((IData)(1U) 
					      + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062136382410362379240109517/LFSRMaxPeriod.v:183
    vlTOPp->LFSRMaxPeriod__DOT__last = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2) 
					 << 2U) | (
    ...
    vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1 
	= __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1;
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2) 
				       << 2U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1) 
						  << 1U) 
						 | (IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_0)));
    vlTOPp->LFSRMaxPeriod__DOT___T_6 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
...
void VLFSRMaxPeriod::_settle__TOP__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->LFSRMaxPeriod__DOT___T_4 = (7U & ((IData)(1U) 
					      + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    vlTOPp->LFSRMaxPeriod__DOT___T_8 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
...
void VLFSRMaxPeriod::_ctor_var_reset() {
    ...
    LFSRMaxPeriod__DOT__rv = VL_RAND_RESET_I(3);
    LFSRMaxPeriod__DOT__started = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__seed = VL_RAND_RESET_I(3);
    LFSRMaxPeriod__DOT__value = VL_RAND_RESET_I(3);
    LFSRMaxPeriod__DOT___T_2 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_4 = VL_RAND_RESET_I(3);
    LFSRMaxPeriod__DOT___T_6 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_8 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__last = VL_RAND_RESET_I(3);
