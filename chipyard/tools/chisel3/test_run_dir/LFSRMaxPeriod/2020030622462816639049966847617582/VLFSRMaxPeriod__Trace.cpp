...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),12);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+14,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+15,(vlTOPp->LFSRMaxPeriod__DOT__seed),12);
	vcdp->chgBus  (c+16,(vlTOPp->LFSRMaxPeriod__DOT__value),12);
	vcdp->chgBit  (c+17,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0xffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+18,(vlTOPp->LFSRMaxPeriod__DOT__last),12);
    }
}
