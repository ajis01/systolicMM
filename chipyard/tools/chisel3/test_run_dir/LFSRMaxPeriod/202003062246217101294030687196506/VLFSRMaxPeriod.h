...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT___T_3,4,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_10,0,0);
    ...
    VL_SIG16(LFSRMaxPeriod__DOT__rv,10,0);
    VL_SIG16(LFSRMaxPeriod__DOT__seed,10,0);
    VL_SIG16(LFSRMaxPeriod__DOT__value,10,0);
    VL_SIG16(LFSRMaxPeriod__DOT___T_12,10,0);
    VL_SIG16(LFSRMaxPeriod__DOT__last,10,0);
