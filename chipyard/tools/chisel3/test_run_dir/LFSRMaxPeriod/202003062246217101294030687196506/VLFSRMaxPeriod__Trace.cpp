...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),11);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+13,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+14,(vlTOPp->LFSRMaxPeriod__DOT__seed),11);
	vcdp->chgBus  (c+15,(vlTOPp->LFSRMaxPeriod__DOT__value),11);
	vcdp->chgBit  (c+16,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0x7feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+17,(vlTOPp->LFSRMaxPeriod__DOT__last),11);
    }
}
