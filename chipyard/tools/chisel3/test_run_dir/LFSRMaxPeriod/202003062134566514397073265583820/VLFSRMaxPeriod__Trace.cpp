...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),8);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+10,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+11,(vlTOPp->LFSRMaxPeriod__DOT__seed),8);
	vcdp->chgBus  (c+12,(vlTOPp->LFSRMaxPeriod__DOT__value),8);
	vcdp->chgBit  (c+13,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0xfeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+14,(vlTOPp->LFSRMaxPeriod__DOT__last),8);
    }
}
