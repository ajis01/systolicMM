...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),5);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+7,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+8,(vlTOPp->LFSRMaxPeriod__DOT__seed),5);
	vcdp->chgBus  (c+9,(vlTOPp->LFSRMaxPeriod__DOT__value),5);
	vcdp->chgBit  (c+10,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0x1eU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+11,(vlTOPp->LFSRMaxPeriod__DOT__last),5);
    }
}
