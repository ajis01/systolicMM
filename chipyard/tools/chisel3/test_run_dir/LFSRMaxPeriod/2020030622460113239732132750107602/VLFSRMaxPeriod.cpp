...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622460113239732132750107602/LFSRMaxPeriod.v:288
    if ((1U & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)))) {
	vlTOPp->LFSRMaxPeriod__DOT__seed = vlTOPp->LFSRMaxPeriod__DOT__rv;
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622460113239732132750107602/LFSRMaxPeriod.v:120
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6 
	...
	if (vlTOPp->LFSRMaxPeriod__DOT__started) {
	    vlTOPp->LFSRMaxPeriod__DOT__value = ((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_9)
						  ? 0U
						  : (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_11));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_13) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_13) 
			 & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_15))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:323: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622460113239732132750107602/LFSRMaxPeriod.v",323,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_13) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622460113239732132750107602/LFSRMaxPeriod.v",334,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
	    ...
	    VL_FWRITEF(0x80000002U,"Assertion failed: LFSR last value (0b%b) was equal to current value (0b%b)\n    at LFSR16.scala:61 chisel3.assert(rv =/= last, \"LFSR last value (0b%%b) was equal to current value (0b%%b)\", rv, last)\n",
		       10,vlTOPp->LFSRMaxPeriod__DOT__rv,
		       10,(IData)(vlTOPp->LFSRMaxPeriod__DOT__last));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
				   != (IData)(vlTOPp->LFSRMaxPeriod__DOT__last)) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:356: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622460113239732132750107602/LFSRMaxPeriod.v",356,"");
	}
    }
    vlTOPp->LFSRMaxPeriod__DOT__started = __Vdly__LFSRMaxPeriod__DOT__started;
    vlTOPp->LFSRMaxPeriod__DOT___T_9 = (0x3feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value));
    vlTOPp->LFSRMaxPeriod__DOT___T_11 = (0x3ffU & ((IData)(1U) 
						   + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030622460113239732132750107602/LFSRMaxPeriod.v:288
    vlTOPp->LFSRMaxPeriod__DOT__last = ((((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_9) 
					  << 9U) | 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6 
	= __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6;
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_9) 
				       << 9U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_8) 
						  << 8U) 
						 | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_7) 
						     << 7U) 
						    | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6) 
							  ...
							  | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4) 
								...
								| (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2) 
								   ...
								   | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1) 
								       << 1U) 
								      | (IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_0))))))))));
    vlTOPp->LFSRMaxPeriod__DOT___T_13 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
...
void VLFSRMaxPeriod::_settle__TOP__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->LFSRMaxPeriod__DOT___T_11 = (0x3ffU & ((IData)(1U) 
						   + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    vlTOPp->LFSRMaxPeriod__DOT___T_15 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
					  & (0x3feU 
					     == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value))) 
					 | (IData)(vlTOPp->reset));
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_9) 
...
void VLFSRMaxPeriod::_ctor_var_reset() {
    ...
    LFSRMaxPeriod__DOT__rv = VL_RAND_RESET_I(10);
    LFSRMaxPeriod__DOT__started = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__seed = VL_RAND_RESET_I(10);
    LFSRMaxPeriod__DOT__value = VL_RAND_RESET_I(10);
    LFSRMaxPeriod__DOT___T_9 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_11 = VL_RAND_RESET_I(10);
    LFSRMaxPeriod__DOT___T_13 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_15 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__last = VL_RAND_RESET_I(10);
