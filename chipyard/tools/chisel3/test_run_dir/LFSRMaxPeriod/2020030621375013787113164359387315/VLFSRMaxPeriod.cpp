...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    VL_SIG8(__Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4,0,0);
    // Body
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4 
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v:283
    if ((1U & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)))) {
	vlTOPp->LFSRMaxPeriod__DOT__seed = vlTOPp->LFSRMaxPeriod__DOT__rv;
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v:122
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4 
	= (1U & ((~ (IData)(vlTOPp->reset)) & (~ ((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_5) 
	...
	if (vlTOPp->LFSRMaxPeriod__DOT__started) {
	    vlTOPp->LFSRMaxPeriod__DOT__value = ((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_8)
						  ? 0U
						  : (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_10));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_12) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_12) 
			 & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_14))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:318: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v",318,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_12) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v",329,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
	    ...
	    VL_FWRITEF(0x80000002U,"Assertion failed: LFSR last value (0b%b) was equal to current value (0b%b)\n    at LFSR16.scala:61 chisel3.assert(rv =/= last, \"LFSR last value (0b%%b) was equal to current value (0b%%b)\", rv, last)\n",
		       9,vlTOPp->LFSRMaxPeriod__DOT__rv,
		       9,(IData)(vlTOPp->LFSRMaxPeriod__DOT__last));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
				   != (IData)(vlTOPp->LFSRMaxPeriod__DOT__last)) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:351: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v",351,"");
	}
    }
    vlTOPp->LFSRMaxPeriod__DOT__started = __Vdly__LFSRMaxPeriod__DOT__started;
    vlTOPp->LFSRMaxPeriod__DOT___T_8 = (0x1feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value));
    vlTOPp->LFSRMaxPeriod__DOT___T_10 = (0x1ffU & ((IData)(1U) 
						   + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v:283
    vlTOPp->LFSRMaxPeriod__DOT__last = ((((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_8) 
					  << 8U) | 
	...
	= (1U & ((~ (IData)(vlTOPp->reset)) & (~ ((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6) 
						  ^ (IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_0)))));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v:122
	...
	= (1U & ((~ (IData)(vlTOPp->reset)) & (~ ((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_8) 
						  ^ (IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_0)))));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621375013787113164359387315/LFSRMaxPeriod.v:122
    ...
    vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4 
	= __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4;
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_8) 
				       << 8U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_7) 
						  << 7U) 
						 | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6) 
						     << 6U) 
						    | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_5) 
							<< 5U) 
							  ...
							  | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_3) 
								...
								| (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1) 
								    << 1U) 
								   | (IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_0)))))))));
    vlTOPp->LFSRMaxPeriod__DOT___T_12 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
...
void VLFSRMaxPeriod::_settle__TOP__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->LFSRMaxPeriod__DOT___T_10 = (0x1ffU & ((IData)(1U) 
						   + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    vlTOPp->LFSRMaxPeriod__DOT___T_14 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
					  & (0x1feU 
					     == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value))) 
					 | (IData)(vlTOPp->reset));
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_8) 
...
void VLFSRMaxPeriod::_ctor_var_reset() {
    ...
    LFSRMaxPeriod__DOT__rv = VL_RAND_RESET_I(9);
    LFSRMaxPeriod__DOT__started = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__seed = VL_RAND_RESET_I(9);
    LFSRMaxPeriod__DOT__value = VL_RAND_RESET_I(9);
    LFSRMaxPeriod__DOT___T_8 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_10 = VL_RAND_RESET_I(9);
    LFSRMaxPeriod__DOT___T_12 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_14 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__last = VL_RAND_RESET_I(9);
