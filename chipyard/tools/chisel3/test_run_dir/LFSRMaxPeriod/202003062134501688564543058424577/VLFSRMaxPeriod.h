...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT__rv,6,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__seed,6,0);
    VL_SIG8(LFSRMaxPeriod__DOT__value,6,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_6,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_8,6,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_10,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_12,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__last,6,0);
