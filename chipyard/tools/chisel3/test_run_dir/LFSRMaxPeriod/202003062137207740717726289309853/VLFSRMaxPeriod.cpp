...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062137207740717726289309853/LFSRMaxPeriod.v:245
    if ((1U & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)))) {
	vlTOPp->LFSRMaxPeriod__DOT__seed = vlTOPp->LFSRMaxPeriod__DOT__rv;
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062137207740717726289309853/LFSRMaxPeriod.v:98
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_5 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_10) 
			 & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_12))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:280: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062137207740717726289309853/LFSRMaxPeriod.v",280,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_10) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062137207740717726289309853/LFSRMaxPeriod.v",291,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
				   != (IData)(vlTOPp->LFSRMaxPeriod__DOT__last)) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:313: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062137207740717726289309853/LFSRMaxPeriod.v",313,"");
	}
    }
