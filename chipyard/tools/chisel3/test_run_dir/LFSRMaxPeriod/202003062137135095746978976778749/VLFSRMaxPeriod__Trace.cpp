...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),6);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+8,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+9,(vlTOPp->LFSRMaxPeriod__DOT__seed),6);
	vcdp->chgBus  (c+10,(vlTOPp->LFSRMaxPeriod__DOT__value),6);
	vcdp->chgBit  (c+11,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0x3eU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+12,(vlTOPp->LFSRMaxPeriod__DOT__last),6);
    }
}
