...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),2);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+4,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+5,(vlTOPp->LFSRMaxPeriod__DOT__seed),2);
	vcdp->chgBus  (c+6,(vlTOPp->LFSRMaxPeriod__DOT__value),2);
	vcdp->chgBit  (c+7,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			     & (2U == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+8,(vlTOPp->LFSRMaxPeriod__DOT__last),2);
    }
}
