...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT__rv,1,0);
    VL_SIG8(LFSRMaxPeriod__DOT__started,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__seed,1,0);
    VL_SIG8(LFSRMaxPeriod__DOT__value,1,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_1,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_3,1,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_5,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_7,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__last,1,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_0,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_1,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT__GaloisLFSR__DOT___T_1,0,0);
