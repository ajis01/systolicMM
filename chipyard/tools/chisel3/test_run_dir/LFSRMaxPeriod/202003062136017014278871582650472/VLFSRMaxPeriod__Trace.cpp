...
void VLFSRMaxPeriod::traceChgThis__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->LFSRMaxPeriod__DOT__rv),14);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__3(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+16,(vlTOPp->LFSRMaxPeriod__DOT__started));
	vcdp->chgBus  (c+17,(vlTOPp->LFSRMaxPeriod__DOT__seed),14);
	vcdp->chgBus  (c+18,(vlTOPp->LFSRMaxPeriod__DOT__value),14);
	vcdp->chgBit  (c+19,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
			      & (0x3ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)))));
	vcdp->chgBus  (c+20,(vlTOPp->LFSRMaxPeriod__DOT__last),14);
    }
}
...
void VLFSRMaxPeriod::traceChgThis__4(VLFSRMaxPeriod__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+21,(vlTOPp->clock));
	vcdp->chgBit  (c+22,(vlTOPp->reset));
    }
}
