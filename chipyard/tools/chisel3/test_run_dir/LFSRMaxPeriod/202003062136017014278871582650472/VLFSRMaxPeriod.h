...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    VL_SIG8(LFSRMaxPeriod__DOT___T_13,0,0);
    VL_SIG8(LFSRMaxPeriod__DOT___T_17,0,0);
    ...
    VL_SIG16(LFSRMaxPeriod__DOT__rv,13,0);
    VL_SIG16(LFSRMaxPeriod__DOT__seed,13,0);
    VL_SIG16(LFSRMaxPeriod__DOT__value,13,0);
    VL_SIG16(LFSRMaxPeriod__DOT___T_15,13,0);
    VL_SIG16(LFSRMaxPeriod__DOT__last,13,0);
