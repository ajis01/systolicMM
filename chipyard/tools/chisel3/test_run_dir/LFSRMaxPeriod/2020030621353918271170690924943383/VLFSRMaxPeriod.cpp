...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    VL_SIG8(__Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6,0,0);
    // Body
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6 
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621353918271170690924943383/LFSRMaxPeriod.v:307
    if ((1U & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)))) {
	vlTOPp->LFSRMaxPeriod__DOT__seed = vlTOPp->LFSRMaxPeriod__DOT__rv;
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621353918271170690924943383/LFSRMaxPeriod.v:132
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6 
	...
	if (vlTOPp->LFSRMaxPeriod__DOT__started) {
	    vlTOPp->LFSRMaxPeriod__DOT__value = ((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_10)
						  ? 0U
						  : (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_12));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_14) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_14) 
			 & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_16))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:342: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621353918271170690924943383/LFSRMaxPeriod.v",342,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_14) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621353918271170690924943383/LFSRMaxPeriod.v",353,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
	    ...
	    VL_FWRITEF(0x80000002U,"Assertion failed: LFSR last value (0b%b) was equal to current value (0b%b)\n    at LFSR16.scala:61 chisel3.assert(rv =/= last, \"LFSR last value (0b%%b) was equal to current value (0b%%b)\", rv, last)\n",
		       11,vlTOPp->LFSRMaxPeriod__DOT__rv,
		       11,(IData)(vlTOPp->LFSRMaxPeriod__DOT__last));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
				   != (IData)(vlTOPp->LFSRMaxPeriod__DOT__last)) 
				  | (IData)(vlTOPp->reset)))))) {
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:375: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621353918271170690924943383/LFSRMaxPeriod.v",375,"");
	}
    }
    vlTOPp->LFSRMaxPeriod__DOT__started = __Vdly__LFSRMaxPeriod__DOT__started;
    vlTOPp->LFSRMaxPeriod__DOT___T_10 = (0x7feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value));
    vlTOPp->LFSRMaxPeriod__DOT___T_12 = (0x7ffU & ((IData)(1U) 
						   + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/2020030621353918271170690924943383/LFSRMaxPeriod.v:307
    vlTOPp->LFSRMaxPeriod__DOT__last = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_10) 
					 << 0xaU) | 
    ...
    vlTOPp->LFSRMaxPeriod__DOT___T_3 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4) 
					 << 4U) | (
    ...
    vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6 
	= __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6;
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_10) 
				       << 0xaU) | (
						   ((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_9) 
						    << 9U) 
						   | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_8) 
							 ...
							 | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_6) 
								...
								<< 5U) 
							       | (IData)(vlTOPp->LFSRMaxPeriod__DOT___T_3)))))));
    vlTOPp->LFSRMaxPeriod__DOT___T_14 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
...
void VLFSRMaxPeriod::_settle__TOP__2(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->LFSRMaxPeriod__DOT___T_12 = (0x7ffU & ((IData)(1U) 
						   + (IData)(vlTOPp->LFSRMaxPeriod__DOT__value)));
    vlTOPp->LFSRMaxPeriod__DOT___T_16 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
					  & (0x7feU 
					     == (IData)(vlTOPp->LFSRMaxPeriod__DOT__value))) 
					 | (IData)(vlTOPp->reset));
    vlTOPp->LFSRMaxPeriod__DOT___T_3 = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_4) 
...
void VLFSRMaxPeriod::_ctor_var_reset() {
    ...
    LFSRMaxPeriod__DOT___T_3 = VL_RAND_RESET_I(5);
    LFSRMaxPeriod__DOT__rv = VL_RAND_RESET_I(11);
    LFSRMaxPeriod__DOT__started = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__seed = VL_RAND_RESET_I(11);
    LFSRMaxPeriod__DOT__value = VL_RAND_RESET_I(11);
    LFSRMaxPeriod__DOT___T_10 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_12 = VL_RAND_RESET_I(11);
    LFSRMaxPeriod__DOT___T_14 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT___T_16 = VL_RAND_RESET_I(1);
    LFSRMaxPeriod__DOT__last = VL_RAND_RESET_I(11);
