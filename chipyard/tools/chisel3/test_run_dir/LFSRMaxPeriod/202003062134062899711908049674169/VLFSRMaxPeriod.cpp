...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062134062899711908049674169/LFSRMaxPeriod.v:198
    if ((1U & (~ (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)))) {
	vlTOPp->LFSRMaxPeriod__DOT__seed = vlTOPp->LFSRMaxPeriod__DOT__rv;
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062134062899711908049674169/LFSRMaxPeriod.v:72
    __Vdly__LFSRMaxPeriod__DOT__GaloisLFSR__DOT__state_2 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_7) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062134062899711908049674169/LFSRMaxPeriod.v",233,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRMaxPeriod__DOT___T_7) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062134062899711908049674169/LFSRMaxPeriod.v",244,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
	    ...
	    VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:266: Assertion failed in %NLFSRMaxPeriod\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRMaxPeriod/202003062134062899711908049674169/LFSRMaxPeriod.v",266,"");
	}
    }
