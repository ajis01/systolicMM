...
VL_INLINE_OPT void VQueueReasonableReadyValid::_sequent__TOP__1(VQueueReasonableReadyValid__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030622451915247058996852391045/QueueReasonableReadyValid.v:462
    if (vlTOPp->reset) {
	...
	if ((((IData)(vlTOPp->QueueReasonableReadyValid__DOT___T_20) 
	      >> 0xfU) & (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_1))) {
	...
	if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_1)) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030622451915247058996852391045/QueueReasonableReadyValid.v",501,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_1) 
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_1) 
	    ...
	    VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:523: Assertion failed in %NQueueReasonableReadyValid\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030622451915247058996852391045/QueueReasonableReadyValid.v",523,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->QueueReasonableReadyValid__DOT___T_32) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030622451915247058996852391045/QueueReasonableReadyValid.v",534,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030622451915247058996852391045/QueueReasonableReadyValid.v:242
    __Vdly__QueueReasonableReadyValid__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030622451915247058996852391045/QueueReasonableReadyValid.v:61
    if (vlTOPp->reset) {
