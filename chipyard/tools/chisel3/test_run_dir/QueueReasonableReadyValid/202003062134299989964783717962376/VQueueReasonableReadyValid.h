...
VL_MODULE(VQueueReasonableReadyValid) {
  public:
    ...
    VL_SIG8(QueueReasonableReadyValid__DOT__q_io_count,1,0);
    ...
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT__value,0,0);
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT__value_1,0,0);
    ...
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT___T_12,0,0);
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT___T_14,0,0);
