...
void VQueueReasonableReadyValid::traceChgThis__3(VQueueReasonableReadyValid__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus  (c+24,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value),2);
	vcdp->chgBus  (c+25,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value_1),2);
	vcdp->chgBit  (c+26,((2U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value))));
	vcdp->chgBit  (c+27,((2U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value_1))));
    }
}
