...
VL_MODULE(VQueueReasonableReadyValid) {
  public:
    ...
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT__wrap,0,0);
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT___T_12,1,0);
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT__wrap_1,0,0);
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT___T_14,1,0);
    VL_SIG8(QueueReasonableReadyValid__DOT__q__DOT___T_20,1,0);
