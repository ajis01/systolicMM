...
VL_INLINE_OPT void VQueueReasonableReadyValid::_sequent__TOP__1(VQueueReasonableReadyValid__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030621350518154376866193756521/QueueReasonableReadyValid.v:90
    if (vlTOPp->reset) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030621350518154376866193756521/QueueReasonableReadyValid.v:504
    if (vlTOPp->reset) {
	...
	if ((1U & (((IData)(vlTOPp->QueueReasonableReadyValid__DOT___T_20) 
		    >> 3U) & (~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_4))))) {
	...
	if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_5)) 
				   | (2U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q_io_count))) 
				  | (IData)(vlTOPp->reset)))))) {
	...
	if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_5)) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030621350518154376866193756521/QueueReasonableReadyValid.v",543,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_4)) 
	    ...
	    VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:565: Assertion failed in %NQueueReasonableReadyValid\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030621350518154376866193756521/QueueReasonableReadyValid.v",565,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->QueueReasonableReadyValid__DOT___T_32) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030621350518154376866193756521/QueueReasonableReadyValid.v",576,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030621350518154376866193756521/QueueReasonableReadyValid.v:90
    if (vlTOPp->reset) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueReasonableReadyValid/2020030621350518154376866193756521/QueueReasonableReadyValid.v:284
    __Vdly__QueueReasonableReadyValid__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
    ...
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_12 
	= (1U & ((IData)(1U) + (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value)));
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_14 
	= (1U & ((IData)(1U) + (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value_1)));
	...
	= ((((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___T_1) 
	     ...
	     ? 2U : 0U) | (1U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value) 
				 - (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__value_1))));
...
void VQueueReasonableReadyValid::_ctor_var_reset() {
    ...
    QueueReasonableReadyValid__DOT__q__DOT__value = VL_RAND_RESET_I(1);
    QueueReasonableReadyValid__DOT__q__DOT__value_1 = VL_RAND_RESET_I(1);
    ...
    QueueReasonableReadyValid__DOT__q__DOT___T_12 = VL_RAND_RESET_I(1);
    QueueReasonableReadyValid__DOT__q__DOT___T_14 = VL_RAND_RESET_I(1);
