...
VL_INLINE_OPT void VLFSRResetTester::_sequent__TOP__1(VLFSRResetTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062244239773761637698201532/LFSRResetTester.v:48
    __Vdly__LFSRResetTester__DOT__lfsr__DOT__state_0 
	= ((3U == (IData)(vlTOPp->LFSRResetTester__DOT__value)) 
	   | (IData)(vlTOPp->LFSRResetTester__DOT__lfsr__DOT___GEN_4));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062244239773761637698201532/LFSRResetTester.v:129
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRResetTester__DOT___T_4) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062244239773761637698201532/LFSRResetTester.v",155,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRResetTester__DOT__done) 
	    ...
	    VL_WRITEF("[%0t] %%Error: LFSRResetTester.v:177: Assertion failed in %NLFSRResetTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062244239773761637698201532/LFSRResetTester.v",177,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRResetTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062244239773761637698201532/LFSRResetTester.v",188,"");
	}
    }
    vlTOPp->LFSRResetTester__DOT__lfsr__DOT__state_0 
	= __Vdly__LFSRResetTester__DOT__lfsr__DOT__state_0;
