...
VL_INLINE_OPT void VLFSRResetTester::_sequent__TOP__1(VLFSRResetTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062133445653434356785880102/LFSRResetTester.v:74
    __Vdly__LFSRResetTester__DOT__lfsr__DOT__state_1 
    ...
    vlTOPp->LFSRResetTester__DOT__lfsr__DOT__state_3 
	= __Vdly__LFSRResetTester__DOT__lfsr__DOT__state_3;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062133445653434356785880102/LFSRResetTester.v:166
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRResetTester__DOT___T_4) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062133445653434356785880102/LFSRResetTester.v",192,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRResetTester__DOT__done) 
	    ...
	    VL_WRITEF("[%0t] %%Error: LFSRResetTester.v:214: Assertion failed in %NLFSRResetTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062133445653434356785880102/LFSRResetTester.v",214,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->LFSRResetTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/LFSRResetTester/202003062133445653434356785880102/LFSRResetTester.v",225,"");
	}
    }
