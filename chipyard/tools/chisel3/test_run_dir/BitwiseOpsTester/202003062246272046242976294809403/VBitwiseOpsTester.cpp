...
VL_INLINE_OPT void VBitwiseOpsTester::_sequent__TOP__1(VBitwiseOpsTester__Syms* __restrict vlSymsp) {
    ...
    VBitwiseOpsTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/BitwiseOpsTester/202003062246272046242976294809403/BitwiseOpsTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/BitwiseOpsTester/202003062246272046242976294809403/BitwiseOpsTester.v",13,"");
	}
    }
}
