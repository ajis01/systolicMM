...
VL_INLINE_OPT void VMixedVecAssignTester::_sequent__TOP__1(VMixedVecAssignTester__Syms* __restrict vlSymsp) {
    ...
    VMixedVecAssignTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecAssignTester/202003062134357732637752127685284/MixedVecAssignTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecAssignTester/202003062134357732637752127685284/MixedVecAssignTester.v",13,"");
	}
    }
}
