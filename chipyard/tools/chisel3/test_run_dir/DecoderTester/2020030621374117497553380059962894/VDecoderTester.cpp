...
VL_INLINE_OPT void VDecoderTester::_sequent__TOP__1(VDecoderTester__Syms* __restrict vlSymsp) {
    ...
    VDecoderTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621374117497553380059962894/DecoderTester.v:90
    vlTOPp->DecoderTester__DOT__value = ((IData)(vlTOPp->reset)
					  ? 0U : (IData)(vlTOPp->DecoderTester__DOT___T_2));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & ((~ ((((0U == (0xadf0c5aU 
					     & vlTOPp->DecoderTester__DOT__dut_io_inst)) 
				     | (0x1e2042a4U 
					== (0x1e23e2a6U 
					    & vlTOPp->DecoderTester__DOT__dut_io_inst))) 
				    | (0x30a641U == 
				       (0x3bb663U & vlTOPp->DecoderTester__DOT__dut_io_inst))) 
				   | (0U == (0xadf0c5aU 
					     & vlTOPp->DecoderTester__DOT__dut_io_inst)))) 
	...
	if (VL_UNLIKELY((1U & ((~ ((((0U == (0xadf0c5aU 
				   ...
				   | (0U == (0xadf0c5aU 
					     & vlTOPp->DecoderTester__DOT__dut_io_inst)))) 
			       & (~ (IData)(vlTOPp->DecoderTester__DOT___T_7)))))) {
	    VL_WRITEF("[%0t] %%Error: DecoderTester.v:112: Assertion failed in %NDecoderTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621374117497553380059962894/DecoderTester.v",112,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & ((~ ((((0U == (0xadf0c5aU 
				   ...
				   | (0U == (0xadf0c5aU 
					     & vlTOPp->DecoderTester__DOT__dut_io_inst)))) 
			       & (~ (IData)(vlTOPp->reset)))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621374117497553380059962894/DecoderTester.v",123,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->DecoderTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621374117497553380059962894/DecoderTester.v",134,"");
	}
    }
