...
VL_INLINE_OPT void VDecoderTester::_sequent__TOP__1(VDecoderTester__Syms* __restrict vlSymsp) {
    ...
    VDecoderTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621375715840012452943000545/DecoderTester.v:88
	...
	if (VL_UNLIKELY((1U & ((~ ((((0x7e3cafd7U == 
				   ...
				   | (1U == (1U & vlTOPp->DecoderTester__DOT___GEN_4)))) 
			       & (~ (IData)(vlTOPp->DecoderTester__DOT___T_7)))))) {
	    VL_WRITEF("[%0t] %%Error: DecoderTester.v:110: Assertion failed in %NDecoderTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621375715840012452943000545/DecoderTester.v",110,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & ((~ ((((0x7e3cafd7U == 
				   ...
				   | (1U == (1U & vlTOPp->DecoderTester__DOT___GEN_4)))) 
			       & (~ (IData)(vlTOPp->reset)))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621375715840012452943000545/DecoderTester.v",121,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->DecoderTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/DecoderTester/2020030621375715840012452943000545/DecoderTester.v",132,"");
	}
    }
    ...
    vlTOPp->DecoderTester__DOT___GEN_4 = ((3U == (IData)(vlTOPp->DecoderTester__DOT__value))
					   ? 1U : (
						   (2U 
						    == (IData)(vlTOPp->DecoderTester__DOT__value))
						    ? 1U
...
void VDecoderTester::_ctor_var_reset() {
    ...
    DecoderTester__DOT___GEN_4 = VL_RAND_RESET_I(31);
