...
VL_INLINE_OPT void VCastToUIntTester::_sequent__TOP__1(VCastToUIntTester__Syms* __restrict vlSymsp) {
    ...
    VCastToUIntTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CastToUIntTester/2020030621333713852934033646446157/CastToUIntTester.v:78
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CastToUIntTester/2020030621333713852934033646446157/CastToUIntTester.v",194,"");
	}
    }
}
