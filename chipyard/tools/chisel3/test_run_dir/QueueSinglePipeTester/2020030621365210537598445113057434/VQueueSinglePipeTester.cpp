...
VL_INLINE_OPT void VQueueSinglePipeTester::_sequent__TOP__1(VQueueSinglePipeTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueSinglePipeTester/2020030621365210537598445113057434/QueueSinglePipeTester.v:458
    if (vlTOPp->reset) {
	...
	if ((((IData)(vlTOPp->QueueSinglePipeTester__DOT___T_15) 
	      >> 0xdU) & (IData)(vlTOPp->QueueSinglePipeTester__DOT__q__DOT___T_1))) {
	...
	if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueueSinglePipeTester__DOT__q_io_enq_ready) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueSinglePipeTester/2020030621365210537598445113057434/QueueSinglePipeTester.v",497,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->QueueSinglePipeTester__DOT___T_29) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueSinglePipeTester/2020030621365210537598445113057434/QueueSinglePipeTester.v",508,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueSinglePipeTester/2020030621365210537598445113057434/QueueSinglePipeTester.v:242
    __Vdly__QueueSinglePipeTester__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
    ...
    vlTOPp->QueueSinglePipeTester__DOT___T_27 = (0x1fU 
						 & ((IData)(1U) 
						    + (IData)(vlTOPp->QueueSinglePipeTester__DOT__value)));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueSinglePipeTester/2020030621365210537598445113057434/QueueSinglePipeTester.v:61
    if (vlTOPp->reset) {
