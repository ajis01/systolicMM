...
VL_INLINE_OPT void VEnableTester::_sequent__TOP__1(VEnableTester__Syms* __restrict vlSymsp) {
    ...
    VEnableTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062135169165593132638537503/EnableTester.v:73
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->EnableTester__DOT__done) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062135169165593132638537503/EnableTester.v",111,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->EnableTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062135169165593132638537503/EnableTester.v",122,"");
	}
    }
