...
VL_INLINE_OPT void VEnableTester::_sequent__TOP__1(VEnableTester__Syms* __restrict vlSymsp) {
    ...
    VEnableTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062245467644742631505104466/EnableTester.v:73
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->EnableTester__DOT__done) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062245467644742631505104466/EnableTester.v",111,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->EnableTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062245467644742631505104466/EnableTester.v",122,"");
	}
    }
...
void VEnableTester::_settle__TOP__2(VEnableTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->EnableTester__DOT___T_8 = (0x3fU & ((IData)(1U) 
						+ (IData)(vlTOPp->EnableTester__DOT__value_1)));
    vlTOPp->EnableTester__DOT___T_11 = ((0x12U == (IData)(vlTOPp->EnableTester__DOT__value)) 
					| (IData)(vlTOPp->reset));
}
