...
VL_INLINE_OPT void VEnableTester::_sequent__TOP__1(VEnableTester__Syms* __restrict vlSymsp) {
    ...
    VEnableTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062245398819499765386417456/EnableTester.v:73
    vlTOPp->EnableTester__DOT__ens = ((IData)(vlTOPp->reset)
				       ? 0xc48a70U : vlTOPp->EnableTester__DOT___T);
    if (vlTOPp->reset) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->EnableTester__DOT__done) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062245398819499765386417456/EnableTester.v",111,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->EnableTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnableTester/202003062245398819499765386417456/EnableTester.v",122,"");
	}
    }
    vlTOPp->EnableTester__DOT___T = (0x7fffffU & (vlTOPp->EnableTester__DOT__ens 
						  >> 1U));
...
void VEnableTester::_settle__TOP__2(VEnableTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->EnableTester__DOT___T_8 = (0x3fU & ((IData)(1U) 
						+ (IData)(vlTOPp->EnableTester__DOT__value_1)));
    vlTOPp->EnableTester__DOT___T_11 = ((9U == (IData)(vlTOPp->EnableTester__DOT__value)) 
					| (IData)(vlTOPp->reset));
}
...
void VEnableTester::_ctor_var_reset() {
    ...
    EnableTester__DOT__ens = VL_RAND_RESET_I(24);
    EnableTester__DOT___T = VL_RAND_RESET_I(23);
