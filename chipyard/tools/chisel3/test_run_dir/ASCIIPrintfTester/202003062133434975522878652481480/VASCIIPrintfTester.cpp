...
VL_INLINE_OPT void VASCIIPrintfTester::_sequent__TOP__1(VASCIIPrintfTester__Syms* __restrict vlSymsp) {
    ...
    VASCIIPrintfTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ASCIIPrintfTester/202003062133434975522878652481480/ASCIIPrintfTester.v:7
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ASCIIPrintfTester/202003062133434975522878652481480/ASCIIPrintfTester.v",24,"");
	}
    }
}
