...
void VMixedVecRegTester::traceChgThis__2(VMixedVecRegTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+3,(vlTOPp->MixedVecRegTester__DOT__reg_4));
	vcdp->chgBit  (c+4,(vlTOPp->MixedVecRegTester__DOT__reg_1));
	vcdp->chgBit  (c+5,(vlTOPp->MixedVecRegTester__DOT__reg_0));
