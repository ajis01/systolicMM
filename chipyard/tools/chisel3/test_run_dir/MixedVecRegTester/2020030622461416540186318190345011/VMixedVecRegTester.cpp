...
VL_INLINE_OPT void VMixedVecRegTester::_sequent__TOP__1(VMixedVecRegTester__Syms* __restrict vlSymsp) {
    ...
    VL_SIG8(__Vdly__MixedVecRegTester__DOT__reg_0,0,0);
    // Body
    ...
    __Vdly__MixedVecRegTester__DOT__reg_0 = vlTOPp->MixedVecRegTester__DOT__reg_0;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v:100
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v:100
    __Vdly__MixedVecRegTester__DOT__reg_0 = (1U & (
						   (~ (IData)(vlTOPp->MixedVecRegTester__DOT__doneReg)) 
						   | (IData)(vlTOPp->MixedVecRegTester__DOT__reg_0)));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v:100
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v",126,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	    ...
	    VL_WRITEF("[%0t] %%Error: MixedVecRegTester.v:148: Assertion failed in %NMixedVecRegTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v",148,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	    ...
	    VL_WRITEF("[%0t] %%Error: MixedVecRegTester.v:170: Assertion failed in %NMixedVecRegTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v",170,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	    ...
	    VL_WRITEF("[%0t] %%Error: MixedVecRegTester.v:192: Assertion failed in %NMixedVecRegTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v",192,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
	    ...
	    VL_WRITEF("[%0t] %%Error: MixedVecRegTester.v:214: Assertion failed in %NMixedVecRegTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v",214,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622461416540186318190345011/MixedVecRegTester.v",225,"");
	}
    }
    vlTOPp->MixedVecRegTester__DOT__reg_0 = __Vdly__MixedVecRegTester__DOT__reg_0;
...
void VMixedVecRegTester::_ctor_var_reset() {
    ...
    MixedVecRegTester__DOT__reg_0 = VL_RAND_RESET_I(1);
