...
void VMixedVecRegTester::traceChgThis__2(VMixedVecRegTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+2,(vlTOPp->MixedVecRegTester__DOT__reg_5));
	vcdp->chgBit  (c+3,(vlTOPp->MixedVecRegTester__DOT__reg_2));
	vcdp->chgBit  (c+4,(vlTOPp->MixedVecRegTester__DOT__reg_0));
	vcdp->chgBit  (c+5,(vlTOPp->MixedVecRegTester__DOT__doneReg));
    }
}
