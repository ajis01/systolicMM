...
VL_INLINE_OPT void VMixedVecRegTester::_sequent__TOP__1(VMixedVecRegTester__Syms* __restrict vlSymsp) {
    ...
    VMixedVecRegTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622462714925867495442343702/MixedVecRegTester.v:49
    vlTOPp->MixedVecRegTester__DOT__doneReg = (1U & 
					       (~ (IData)(vlTOPp->reset)));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->MixedVecRegTester__DOT___GEN_8) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MixedVecRegTester/2020030622462714925867495442343702/MixedVecRegTester.v",60,"");
	}
    }
