...
void VMixedVecRegTester::traceChgThis__2(VMixedVecRegTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+1,(vlTOPp->MixedVecRegTester__DOT__reg_7));
	vcdp->chgBit  (c+2,(vlTOPp->MixedVecRegTester__DOT__reg_6));
	vcdp->chgBit  (c+3,(vlTOPp->MixedVecRegTester__DOT__reg_5));
	vcdp->chgBit  (c+4,(vlTOPp->MixedVecRegTester__DOT__reg_4));
	vcdp->chgBit  (c+5,(vlTOPp->MixedVecRegTester__DOT__reg_3));
	vcdp->chgBit  (c+6,(vlTOPp->MixedVecRegTester__DOT__reg_2));
	vcdp->chgBit  (c+7,(vlTOPp->MixedVecRegTester__DOT__doneReg));
    }
}
