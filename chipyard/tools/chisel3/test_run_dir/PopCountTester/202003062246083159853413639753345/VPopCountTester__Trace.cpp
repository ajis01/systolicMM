...
void VPopCountTester::traceChgThis__2(VPopCountTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->PopCountTester__DOT__x),4);
	vcdp->chgBus  (c+2,((7U & ((3U & ((1U & (IData)(vlTOPp->PopCountTester__DOT__x)) 
					  + (1U & ((IData)(vlTOPp->PopCountTester__DOT__x) 
						   >> 1U)))) 
				   + (3U & ((1U & ((IData)(vlTOPp->PopCountTester__DOT__x) 
						   >> 2U)) 
					    + (1U & 
					       ((IData)(vlTOPp->PopCountTester__DOT__x) 
						>> 3U))))))),3);
	vcdp->chgBus  (c+3,((0x1fU & ((0xfU & ((7U 
						& ((1U 
						    & (IData)(vlTOPp->PopCountTester__DOT__x)) 
						   + 
						   (1U 
