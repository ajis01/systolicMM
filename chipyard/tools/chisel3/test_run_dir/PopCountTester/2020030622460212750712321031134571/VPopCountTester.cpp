...
VL_INLINE_OPT void VPopCountTester::_sequent__TOP__1(VPopCountTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PopCountTester/2020030622460212750712321031134571/PopCountTester.v:91
    __Vdly__PopCountTester__DOT___T_4 = (0xfU == (IData)(vlTOPp->PopCountTester__DOT__x));
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PopCountTester/2020030622460212750712321031134571/PopCountTester.v:91
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->PopCountTester__DOT___T_4) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PopCountTester/2020030622460212750712321031134571/PopCountTester.v",101,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->PopCountTester__DOT___T_25))))) {
	    VL_FWRITEF(0x80000002U,"Assertion failed\n    at PopCount.scala:16 assert(result === expected)\n");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->PopCountTester__DOT___T_25))))) {
	    VL_WRITEF("[%0t] %%Error: PopCountTester.v:123: Assertion failed in %NPopCountTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PopCountTester/2020030622460212750712321031134571/PopCountTester.v",123,"");
	}
    }
    vlTOPp->PopCountTester__DOT___T_4 = __Vdly__PopCountTester__DOT___T_4;
    vlTOPp->PopCountTester__DOT___T_1 = (0xfU & ((IData)(1U) 
...
void VPopCountTester::_settle__TOP__2(VPopCountTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->PopCountTester__DOT___T_1 = (0xfU & ((IData)(1U) 
						 + (IData)(vlTOPp->PopCountTester__DOT__x)));
    vlTOPp->PopCountTester__DOT___T_25 = (((7U & ((3U 
						   & ((1U 
						       & (IData)(vlTOPp->PopCountTester__DOT__x)) 
						      + 
						      (1U 
...
void VPopCountTester::_ctor_var_reset() {
    ...
    PopCountTester__DOT__x = VL_RAND_RESET_I(4);
    PopCountTester__DOT___T_1 = VL_RAND_RESET_I(4);
    PopCountTester__DOT___T_4 = VL_RAND_RESET_I(1);
    PopCountTester__DOT___T_25 = VL_RAND_RESET_I(1);
