...
VL_INLINE_OPT void VPopCountTester::_sequent__TOP__1(VPopCountTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PopCountTester/2020030622461411715763985108646894/PopCountTester.v:63
    __Vdly__PopCountTester__DOT___T_4 = vlTOPp->PopCountTester__DOT__x;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PopCountTester/2020030622461411715763985108646894/PopCountTester.v:63
    vlTOPp->PopCountTester__DOT__x = ((~ (IData)(vlTOPp->reset)) 
				      & (IData)(vlTOPp->PopCountTester__DOT___T_1));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->PopCountTester__DOT___T_4) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PopCountTester/2020030622461411715763985108646894/PopCountTester.v",73,"");
	}
    }
    vlTOPp->PopCountTester__DOT___T_4 = __Vdly__PopCountTester__DOT___T_4;
    vlTOPp->PopCountTester__DOT___T_1 = (1U & ((IData)(1U) 
...
void VPopCountTester::_ctor_var_reset() {
    ...
    PopCountTester__DOT__x = VL_RAND_RESET_I(1);
    PopCountTester__DOT___T_1 = VL_RAND_RESET_I(1);
