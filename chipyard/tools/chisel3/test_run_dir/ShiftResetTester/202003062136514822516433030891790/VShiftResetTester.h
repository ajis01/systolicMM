...
VL_MODULE(VShiftResetTester) {
  public:
    ...
    VL_SIG8(ShiftResetTester__DOT__value,1,0);
    VL_SIG8(ShiftResetTester__DOT__done,0,0);
    VL_SIG8(ShiftResetTester__DOT___T_2,1,0);
    VL_SIG8(ShiftResetTester__DOT___T_4,4,0);
    VL_SIG8(ShiftResetTester__DOT___T_5,4,0);
    VL_SIG8(ShiftResetTester__DOT___T_6,4,0);
    VL_SIG8(ShiftResetTester__DOT___T_7,4,0);
    VL_SIG8(ShiftResetTester__DOT__sr,4,0);
    VL_SIG8(ShiftResetTester__DOT___T_10,0,0);
