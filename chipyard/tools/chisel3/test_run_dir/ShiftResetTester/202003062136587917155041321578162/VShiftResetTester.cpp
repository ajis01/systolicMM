...
VL_INLINE_OPT void VShiftResetTester::_sequent__TOP__1(VShiftResetTester__Syms* __restrict vlSymsp) {
    ...
    VShiftResetTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG8(__Vdly__ShiftResetTester__DOT___T_2,4,0);
    // Body
    __Vdly__ShiftResetTester__DOT___T_2 = vlTOPp->ShiftResetTester__DOT___T_2;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftResetTester/202003062136587917155041321578162/ShiftResetTester.v:57
    __Vdly__ShiftResetTester__DOT___T_2 = ((IData)(vlTOPp->reset)
					    ? 1U : 0x17U);
    vlTOPp->ShiftResetTester__DOT__sr = ((IData)(vlTOPp->reset)
					  ? 1U : (IData)(vlTOPp->ShiftResetTester__DOT___T_2));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->ShiftResetTester__DOT___T_5))))) {
	    VL_FWRITEF(0x80000002U,"Assertion failed\n    at Reg.scala:57 assert(sr === 1.U)\n");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->ShiftResetTester__DOT___T_5))))) {
	    VL_WRITEF("[%0t] %%Error: ShiftResetTester.v:84: Assertion failed in %NShiftResetTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftResetTester/202003062136587917155041321578162/ShiftResetTester.v",84,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftResetTester/202003062136587917155041321578162/ShiftResetTester.v",95,"");
	}
    }
    vlTOPp->ShiftResetTester__DOT___T_2 = __Vdly__ShiftResetTester__DOT___T_2;
}
...
VL_INLINE_OPT void VShiftResetTester::_settle__TOP__2(VShiftResetTester__Syms* __restrict vlSymsp) {
    ...
    VShiftResetTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->ShiftResetTester__DOT___T_5 = ((1U == (IData)(vlTOPp->ShiftResetTester__DOT__sr)) 
					   | (IData)(vlTOPp->reset));
}
...
void VShiftResetTester::_ctor_var_reset() {
    ...
    ShiftResetTester__DOT___T_2 = VL_RAND_RESET_I(5);
    ShiftResetTester__DOT__sr = VL_RAND_RESET_I(5);
    ShiftResetTester__DOT___T_5 = VL_RAND_RESET_I(1);
