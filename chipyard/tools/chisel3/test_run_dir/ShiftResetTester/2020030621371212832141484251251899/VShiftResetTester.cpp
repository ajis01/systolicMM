...
VL_INLINE_OPT void VShiftResetTester::_sequent__TOP__1(VShiftResetTester__Syms* __restrict vlSymsp) {
    ...
    VShiftResetTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG8(__Vdly__ShiftResetTester__DOT__value,0,0);
    ...
    __Vdly__ShiftResetTester__DOT__value = vlTOPp->ShiftResetTester__DOT__value;
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftResetTester/2020030621371212832141484251251899/ShiftResetTester.v:75
    __Vdly__ShiftResetTester__DOT__value = ((~ (IData)(vlTOPp->reset)) 
					    & (IData)(vlTOPp->ShiftResetTester__DOT___T_2));
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftResetTester__DOT__value) 
			 & (~ (IData)(vlTOPp->ShiftResetTester__DOT___T_9))))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftResetTester__DOT__value) 
			 & (~ (IData)(vlTOPp->ShiftResetTester__DOT___T_9))))) {
	    VL_WRITEF("[%0t] %%Error: ShiftResetTester.v:112: Assertion failed in %NShiftResetTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftResetTester/2020030621371212832141484251251899/ShiftResetTester.v",112,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->ShiftResetTester__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ShiftResetTester/2020030621371212832141484251251899/ShiftResetTester.v",123,"");
	}
    }
    ...
    vlTOPp->ShiftResetTester__DOT__value = __Vdly__ShiftResetTester__DOT__value;
    vlTOPp->ShiftResetTester__DOT___T_2 = (1U & ((IData)(1U) 
...
void VShiftResetTester::_settle__TOP__2(VShiftResetTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->ShiftResetTester__DOT___T_4 = (0x1fU & 
					   ((IData)(0x17U) 
					    + (IData)(vlTOPp->ShiftResetTester__DOT__value)));
    vlTOPp->ShiftResetTester__DOT___T_9 = ((1U == (IData)(vlTOPp->ShiftResetTester__DOT__sr)) 
					   | (IData)(vlTOPp->reset));
}
...
void VShiftResetTester::_ctor_var_reset() {
    ...
    ShiftResetTester__DOT__value = VL_RAND_RESET_I(1);
    ShiftResetTester__DOT___T_2 = VL_RAND_RESET_I(1);
    ...
    ShiftResetTester__DOT___T_9 = VL_RAND_RESET_I(1);
