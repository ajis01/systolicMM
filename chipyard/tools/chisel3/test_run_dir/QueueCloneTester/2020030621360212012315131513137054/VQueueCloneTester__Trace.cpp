...
void VQueueCloneTester::traceChgThis__2(VQueueCloneTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+1,((1U & (~ (IData)(vlTOPp->QueueCloneTester__DOT__dut__DOT__MultiIOQueue__DOT__impl__DOT___T_5)))));
	vcdp->chgBit  (c+2,((1U & (~ (IData)(vlTOPp->QueueCloneTester__DOT__dut__DOT___T__DOT__impl__DOT___T_4)))));
	vcdp->chgBit  (c+3,((1U & (~ (IData)(vlTOPp->QueueCloneTester__DOT__dut__DOT___T__DOT__impl__DOT___T_5)))));
	vcdp->chgBit  (c+4,((1U & (~ (IData)(vlTOPp->QueueCloneTester__DOT__dut__DOT__MultiIOQueue__DOT__impl__DOT___T_4)))));
    }
}
...
void VQueueCloneTester::traceChgThis__3(VQueueCloneTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus  (c+7,(vlTOPp->QueueCloneTester__DOT__dut__DOT___T__DOT__impl__DOT___T
			    [vlTOPp->QueueCloneTester__DOT__dut__DOT___T__DOT__impl__DOT__value_1]),32);
	vcdp->chgBus  (c+8,(vlTOPp->QueueCloneTester__DOT__dut__DOT__MultiIOQueue__DOT__impl__DOT___T
			    [vlTOPp->QueueCloneTester__DOT__dut__DOT__MultiIOQueue__DOT__impl__DOT__value_1]),32);
	vcdp->chgBit  (c+9,(vlTOPp->QueueCloneTester__DOT__dut__DOT__MultiIOQueue__DOT__impl__DOT__value));
	vcdp->chgBit  (c+10,(vlTOPp->QueueCloneTester__DOT__dut__DOT__MultiIOQueue__DOT__impl__DOT__value_1));
    }
}
