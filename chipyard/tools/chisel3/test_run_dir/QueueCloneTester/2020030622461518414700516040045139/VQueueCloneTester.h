...
VL_MODULE(VQueueCloneTester) {
  public:
    ...
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT__value,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT__value_1,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_1,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_2,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_4,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_5,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_6,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_8,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_12,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T_14,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT__value,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT__value_1,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_1,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_2,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_4,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_5,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_6,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_8,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_12,0,0);
    VL_SIG8(QueueCloneTester__DOT__dut__DOT___T__DOT___T_14,0,0);
    VL_SIG(QueueCloneTester__DOT__dut__DOT__Queue__DOT___T[2],31,0);
    VL_SIG(QueueCloneTester__DOT__dut__DOT___T__DOT___T[2],31,0);
