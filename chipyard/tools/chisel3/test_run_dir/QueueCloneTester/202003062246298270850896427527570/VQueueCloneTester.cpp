...
VL_INLINE_OPT void VQueueCloneTester::_sequent__TOP__1(VQueueCloneTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueCloneTester/202003062246298270850896427527570/QueueCloneTester.v:102
    if (vlTOPp->reset) {
    ...
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueCloneTester/202003062246298270850896427527570/QueueCloneTester.v:103
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueCloneTester/202003062246298270850896427527570/QueueCloneTester.v:304
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->QueueCloneTester__DOT___T_1) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueCloneTester/202003062246298270850896427527570/QueueCloneTester.v",327,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->QueueCloneTester__DOT___T_1) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueCloneTester/202003062246298270850896427527570/QueueCloneTester.v",338,"");
	}
    }
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/QueueCloneTester/202003062246298270850896427527570/QueueCloneTester.v:103
