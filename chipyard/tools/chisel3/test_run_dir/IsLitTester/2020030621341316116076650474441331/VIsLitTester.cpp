...
VL_INLINE_OPT void VIsLitTester::_sequent__TOP__1(VIsLitTester__Syms* __restrict vlSymsp) {
    ...
    VIsLitTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/IsLitTester/2020030621341316116076650474441331/IsLitTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/IsLitTester/2020030621341316116076650474441331/IsLitTester.v",13,"");
	}
    }
}
