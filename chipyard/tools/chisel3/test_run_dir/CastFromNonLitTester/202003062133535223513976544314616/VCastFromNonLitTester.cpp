...
VL_INLINE_OPT void VCastFromNonLitTester::_sequent__TOP__1(VCastFromNonLitTester__Syms* __restrict vlSymsp) {
    ...
    VCastFromNonLitTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CastFromNonLitTester/202003062133535223513976544314616/CastFromNonLitTester.v:1981
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CastFromNonLitTester/202003062133535223513976544314616/CastFromNonLitTester.v",4913,"");
	}
    }
}
