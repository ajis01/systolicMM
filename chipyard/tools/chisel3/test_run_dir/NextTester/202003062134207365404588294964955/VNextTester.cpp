...
VL_INLINE_OPT void VNextTester::_sequent__TOP__1(VNextTester__Syms* __restrict vlSymsp) {
    ...
    VNextTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/NextTester/202003062134207365404588294964955/NextTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/NextTester/202003062134207365404588294964955/NextTester.v",13,"");
	}
    }
}
