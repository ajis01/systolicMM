...
VL_INLINE_OPT void VGCDTester::_sequent__TOP__1(VGCDTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/GCDTester/2020030621334413398148534598514959/GCDTester.v:60
    if (vlTOPp->GCDTester__DOT__first) {
	__Vdly__GCDTester__DOT__dut__DOT__x = 0xcU;
    } else {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/GCDTester/2020030621334413398148534598514959/GCDTester.v:60
    if (vlTOPp->GCDTester__DOT__first) {
	vlTOPp->GCDTester__DOT__dut__DOT__y = 9U;
    } else {
	if ((1U & (~ (IData)(vlTOPp->GCDTester__DOT__dut__DOT___T)))) {
	    vlTOPp->GCDTester__DOT__dut__DOT__y = vlTOPp->GCDTester__DOT__dut__DOT___T_4;
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/GCDTester/2020030621334413398148534598514959/GCDTester.v:144
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->GCDTester__DOT___T_1) 
			 & (~ ((3U == vlTOPp->GCDTester__DOT__dut__DOT__x) 
			       | (IData)(vlTOPp->reset)))))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->GCDTester__DOT___T_1) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/GCDTester/2020030621334413398148534598514959/GCDTester.v",162,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->GCDTester__DOT___T_1) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/GCDTester/2020030621334413398148534598514959/GCDTester.v",173,"");
	}
    }
