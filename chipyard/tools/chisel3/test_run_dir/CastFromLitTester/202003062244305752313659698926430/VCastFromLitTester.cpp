...
VL_INLINE_OPT void VCastFromLitTester::_sequent__TOP__1(VCastFromLitTester__Syms* __restrict vlSymsp) {
    ...
    VCastFromLitTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CastFromLitTester/202003062244305752313659698926430/CastFromLitTester.v:182
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CastFromLitTester/202003062244305752313659698926430/CastFromLitTester.v",298,"");
	}
    }
}
