...
VL_INLINE_OPT void VEnumOpsTester::_sequent__TOP__1(VEnumOpsTester__Syms* __restrict vlSymsp) {
    ...
    VEnumOpsTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnumOpsTester/202003062244503982501091943996316/EnumOpsTester.v:1424
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/EnumOpsTester/202003062244503982501091943996316/EnumOpsTester.v",4730,"");
	}
    }
}
