...
VL_INLINE_OPT void V_10::_sequent__TOP__1(V_10__Syms* __restrict vlSymsp) {
    ...
    V_10* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_10/202003062133594017922960751792707/_10.v:49
    vlTOPp->_10__DOT__value = ((IData)(vlTOPp->reset)
			        ? 0U : (IData)(vlTOPp->_10__DOT___T_10));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->_10__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_10/202003062133594017922960751792707/_10.v",60,"");
	}
    }
