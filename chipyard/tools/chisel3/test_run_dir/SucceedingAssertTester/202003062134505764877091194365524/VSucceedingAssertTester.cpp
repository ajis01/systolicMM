...
VL_INLINE_OPT void VSucceedingAssertTester::_sequent__TOP__1(VSucceedingAssertTester__Syms* __restrict vlSymsp) {
    ...
    VSucceedingAssertTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/SucceedingAssertTester/202003062134505764877091194365524/SucceedingAssertTester.v:51
    if (vlTOPp->reset) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->SucceedingAssertTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/SucceedingAssertTester/202003062134505764877091194365524/SucceedingAssertTester.v",64,"");
	}
    }
