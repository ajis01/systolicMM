...
VL_INLINE_OPT void VStopImmediatelyTester::_sequent__TOP__1(VStopImmediatelyTester__Syms* __restrict vlSymsp) {
    ...
    VStopImmediatelyTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StopImmediatelyTester/202003062245391556080083679771005/StopImmediatelyTester.v:55
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->StopImmediatelyTester__DOT___T_2) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StopImmediatelyTester/202003062245391556080083679771005/StopImmediatelyTester.v",66,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->StopImmediatelyTester__DOT___T_7))))) {
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StopImmediatelyTester/202003062245391556080083679771005/StopImmediatelyTester.v",88,"");
	}
    }
