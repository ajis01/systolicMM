...
VL_INLINE_OPT void V_2::_sequent__TOP__1(V_2__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_2/2020030622443616479610613859649955/_2.v:47
    __Vdly___2__DOT__value = ((~ (IData)(vlTOPp->reset)) 
			      & (IData)(vlTOPp->_2__DOT___T_5));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->_2__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_2/2020030622443616479610613859649955/_2.v",58,"");
	}
    }
