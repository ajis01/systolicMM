...
VL_INLINE_OPT void VSomeOptionBundleTester::_sequent__TOP__1(VSomeOptionBundleTester__Syms* __restrict vlSymsp) {
    ...
    VSomeOptionBundleTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/SomeOptionBundleTester/20200306213705418614094599744601/SomeOptionBundleTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/SomeOptionBundleTester/20200306213705418614094599744601/SomeOptionBundleTester.v",13,"");
	}
    }
}
