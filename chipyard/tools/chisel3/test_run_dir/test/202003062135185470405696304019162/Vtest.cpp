...
void Vtest::_initial__TOP__1(Vtest__Syms* __restrict vlSymsp) {
    ...
    Vtest* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // INITIAL at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/test/202003062135185470405696304019162/test.v:3
	...
	VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/test/202003062135185470405696304019162/test.v",4,"");
    }
    VL_WRITEF("test!\n");
    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/test/202003062135185470405696304019162/test.v",6,"");
}
...
void Vtest::_eval(Vtest__Syms* __restrict vlSymsp) {
    ...
    Vtest* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Tracing activity check at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/test/202003062135185470405696304019162/test.v:2
}
