...
VL_MODULE(VTblTester) {
  public:
    ...
    VL_SIG8(TblTester__DOT__dut_io_wi,2,0);
    VL_SIG8(TblTester__DOT__dut_io_ri,2,0);
    VL_SIG8(TblTester__DOT__dut_io_d,2,0);
    VL_SIG8(TblTester__DOT__dut_io_o,2,0);
    VL_SIG8(TblTester__DOT__value,2,0);
    VL_SIG8(TblTester__DOT__wrap,0,0);
    VL_SIG8(TblTester__DOT___T_2,2,0);
    VL_SIG8(TblTester__DOT___GEN_7,2,0);
    VL_SIG8(TblTester__DOT___GEN_15,2,0);
    VL_SIG8(TblTester__DOT___GEN_23,2,0);
    ...
    VL_SIG8(TblTester__DOT__dut__DOT__m[8],2,0);
