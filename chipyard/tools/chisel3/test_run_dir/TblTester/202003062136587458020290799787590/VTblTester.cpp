...
VL_INLINE_OPT void VTblTester::_sequent__TOP__1(VTblTester__Syms* __restrict vlSymsp) {
    ...
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062136587458020290799787590/TblTester.v:62
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062136587458020290799787590/TblTester.v:224
    vlTOPp->TblTester__DOT__value = ((IData)(vlTOPp->reset)
				      ? 0U : (IData)(vlTOPp->TblTester__DOT___T_2));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_45) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_45) 
			 & (~ (IData)(vlTOPp->TblTester__DOT___T_11))))) {
	    VL_WRITEF("[%0t] %%Error: TblTester.v:246: Assertion failed in %NTblTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062136587458020290799787590/TblTester.v",246,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_48) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_48) 
			 & (~ (IData)(vlTOPp->TblTester__DOT___T_15))))) {
	    VL_WRITEF("[%0t] %%Error: TblTester.v:268: Assertion failed in %NTblTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062136587458020290799787590/TblTester.v",268,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062136587458020290799787590/TblTester.v",279,"");
	}
    }
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062136587458020290799787590/TblTester.v:64
    ...
    vlTOPp->TblTester__DOT__dut_io_ri = ((7U != (7U 
						 & ((IData)(vlTOPp->TblTester__DOT__value) 
						    - (IData)(1U)))) 
					 & (IData)(vlTOPp->TblTester__DOT___GEN_15));
    vlTOPp->TblTester__DOT___GEN_45 = ((0U < (IData)(vlTOPp->TblTester__DOT__value)) 
				       & (IData)(vlTOPp->TblTester__DOT___T_8));
    vlTOPp->TblTester__DOT___GEN_48 = ((0U < (IData)(vlTOPp->TblTester__DOT__value)) 
				       & (~ (IData)(vlTOPp->TblTester__DOT___T_8)));
...
void VTblTester::_ctor_var_reset() {
    ...
    TblTester__DOT___GEN_45 = VL_RAND_RESET_I(1);
    TblTester__DOT___GEN_48 = VL_RAND_RESET_I(1);
