...
VL_INLINE_OPT void VTblTester::_sequent__TOP__1(VTblTester__Syms* __restrict vlSymsp) {
    ...
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621372811980065429952240361/TblTester.v:62
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621372811980065429952240361/TblTester.v:212
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_33) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621372811980065429952240361/TblTester.v",234,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_36) 
	    ...
	    VL_WRITEF("[%0t] %%Error: TblTester.v:256: Assertion failed in %NTblTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621372811980065429952240361/TblTester.v",256,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621372811980065429952240361/TblTester.v",267,"");
	}
    }
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621372811980065429952240361/TblTester.v:64
    ...
    vlTOPp->TblTester__DOT__dut_io_wi = ((7U == (IData)(vlTOPp->TblTester__DOT__value))
					  ? 8U : (IData)(vlTOPp->TblTester__DOT___GEN_7));
    vlTOPp->TblTester__DOT___T_8 = (((7U == (7U & ((IData)(vlTOPp->TblTester__DOT__value) 
						   - (IData)(1U))))
				      ? 8U : (IData)(vlTOPp->TblTester__DOT___GEN_15)) 
