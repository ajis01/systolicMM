...
VL_INLINE_OPT void VTblTester::_sequent__TOP__1(VTblTester__Syms* __restrict vlSymsp) {
    ...
    VTblTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG8(__Vdlyvdim0__TblTester__DOT__dut__DOT__m__v0,1,0);
    VL_SIG8(__Vdlyvval__TblTester__DOT__dut__DOT__m__v0,1,0);
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621370518390094565639003051/TblTester.v:62
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621370518390094565639003051/TblTester.v:208
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_33) 
			 & (~ (IData)(vlTOPp->TblTester__DOT___T_11))))) {
	    VL_WRITEF("[%0t] %%Error: TblTester.v:230: Assertion failed in %NTblTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621370518390094565639003051/TblTester.v",230,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_36) 
			 & (~ (IData)(vlTOPp->TblTester__DOT___T_15))))) {
	    VL_WRITEF("[%0t] %%Error: TblTester.v:252: Assertion failed in %NTblTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621370518390094565639003051/TblTester.v",252,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621370518390094565639003051/TblTester.v",263,"");
	}
    }
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/2020030621370518390094565639003051/TblTester.v:64
...
void VTblTester::_ctor_var_reset() {
    ...
    TblTester__DOT__dut_io_wi = VL_RAND_RESET_I(2);
    TblTester__DOT__dut_io_ri = VL_RAND_RESET_I(2);
    TblTester__DOT__dut_io_d = VL_RAND_RESET_I(2);
    TblTester__DOT__dut_io_o = VL_RAND_RESET_I(2);
    TblTester__DOT__value = VL_RAND_RESET_I(3);
    TblTester__DOT__wrap = VL_RAND_RESET_I(1);
    TblTester__DOT___T_2 = VL_RAND_RESET_I(3);
    TblTester__DOT___GEN_7 = VL_RAND_RESET_I(2);
    TblTester__DOT___GEN_15 = VL_RAND_RESET_I(2);
    TblTester__DOT___GEN_23 = VL_RAND_RESET_I(2);
    ...
    { int __Vi0=0; for (; __Vi0<4; ++__Vi0) {
	    TblTester__DOT__dut__DOT__m[__Vi0] = VL_RAND_RESET_I(2);
    }}
