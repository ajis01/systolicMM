...
VL_MODULE(VTblTester) {
  public:
    ...
    VL_SIG8(TblTester__DOT__dut_io_wi,1,0);
    VL_SIG8(TblTester__DOT__dut_io_ri,1,0);
    VL_SIG8(TblTester__DOT__dut_io_d,1,0);
    VL_SIG8(TblTester__DOT__dut_io_o,1,0);
    VL_SIG8(TblTester__DOT__value,2,0);
    VL_SIG8(TblTester__DOT__wrap,0,0);
    VL_SIG8(TblTester__DOT___T_2,2,0);
    VL_SIG8(TblTester__DOT___GEN_7,1,0);
    VL_SIG8(TblTester__DOT___GEN_15,1,0);
    VL_SIG8(TblTester__DOT___GEN_23,1,0);
    ...
    VL_SIG8(TblTester__DOT__dut__DOT__m[4],1,0);
