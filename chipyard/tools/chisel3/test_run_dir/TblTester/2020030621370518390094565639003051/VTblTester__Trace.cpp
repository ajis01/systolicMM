...
void VTblTester::traceChgThis__2(VTblTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus  (c+1,(vlTOPp->TblTester__DOT__dut_io_wi),2);
	vcdp->chgBus  (c+2,(vlTOPp->TblTester__DOT__dut_io_ri),2);
	vcdp->chgBus  (c+3,(vlTOPp->TblTester__DOT__dut_io_d),2);
	vcdp->chgBus  (c+4,(vlTOPp->TblTester__DOT__dut_io_o),2);
...
void VTblTester::traceChgThis__3(VTblTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus  (c+8,(vlTOPp->TblTester__DOT__dut__DOT__m[0]),2);
	vcdp->chgBus  (c+9,(vlTOPp->TblTester__DOT__dut__DOT__m[1]),2);
	vcdp->chgBus  (c+10,(vlTOPp->TblTester__DOT__dut__DOT__m[2]),2);
	vcdp->chgBus  (c+11,(vlTOPp->TblTester__DOT__dut__DOT__m[3]),2);
    }
}
