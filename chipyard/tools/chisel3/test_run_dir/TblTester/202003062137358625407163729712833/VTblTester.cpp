...
VL_INLINE_OPT void VTblTester::_sequent__TOP__1(VTblTester__Syms* __restrict vlSymsp) {
    ...
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062137358625407163729712833/TblTester.v:62
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062137358625407163729712833/TblTester.v:208
    vlTOPp->TblTester__DOT__value = ((IData)(vlTOPp->reset)
				      ? 0U : (IData)(vlTOPp->TblTester__DOT___T_2));
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_43) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_43) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062137358625407163729712833/TblTester.v",230,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_46) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT___GEN_46) 
	    ...
	    VL_WRITEF("[%0t] %%Error: TblTester.v:252: Assertion failed in %NTblTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062137358625407163729712833/TblTester.v",252,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->TblTester__DOT__wrap) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062137358625407163729712833/TblTester.v",263,"");
	}
    }
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/TblTester/202003062137358625407163729712833/TblTester.v:64
    ...
    vlTOPp->TblTester__DOT__dut_io_ri = ((7U == (7U 
						 & ((IData)(vlTOPp->TblTester__DOT__value) 
						    - (IData)(1U)))) 
					 | (IData)(vlTOPp->TblTester__DOT___GEN_15));
    vlTOPp->TblTester__DOT___GEN_43 = ((0U < (IData)(vlTOPp->TblTester__DOT__value)) 
				       & (IData)(vlTOPp->TblTester__DOT___T_8));
    vlTOPp->TblTester__DOT___GEN_46 = ((0U < (IData)(vlTOPp->TblTester__DOT__value)) 
				       & (~ (IData)(vlTOPp->TblTester__DOT___T_8)));
...
void VTblTester::_ctor_var_reset() {
    ...
    TblTester__DOT___GEN_43 = VL_RAND_RESET_I(1);
    TblTester__DOT___GEN_46 = VL_RAND_RESET_I(1);
