...
VL_MODULE(VTblTester) {
  public:
    ...
    VL_SIG8(TblTester__DOT__dut_io_wi,3,0);
    VL_SIG8(TblTester__DOT__dut_io_ri,3,0);
    VL_SIG8(TblTester__DOT__dut_io_d,3,0);
    VL_SIG8(TblTester__DOT__dut_io_o,3,0);
    VL_SIG8(TblTester__DOT__value,2,0);
    VL_SIG8(TblTester__DOT__wrap,0,0);
    VL_SIG8(TblTester__DOT___T_2,2,0);
    VL_SIG8(TblTester__DOT___GEN_7,3,0);
    VL_SIG8(TblTester__DOT___GEN_15,3,0);
    VL_SIG8(TblTester__DOT___GEN_23,3,0);
    VL_SIG8(TblTester__DOT___T_8,0,0);
    VL_SIG8(TblTester__DOT___T_11,0,0);
    VL_SIG8(TblTester__DOT___T_15,0,0);
    VL_SIG8(TblTester__DOT___GEN_33,0,0);
    VL_SIG8(TblTester__DOT___GEN_36,0,0);
    VL_SIG8(TblTester__DOT__dut__DOT__m[16],3,0);
