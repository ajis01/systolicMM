...
VL_INLINE_OPT void VStrongEnumFSMTester::_sequent__TOP__1(VStrongEnumFSMTester__Syms* __restrict vlSymsp) {
    ...
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StrongEnumFSMTester/2020030622451917629993952480544757/StrongEnumFSMTester.v:213
	...
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->StrongEnumFSMTester__DOT___T_2))))) {
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StrongEnumFSMTester/2020030622451917629993952480544757/StrongEnumFSMTester.v",239,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->StrongEnumFSMTester__DOT___T_6))))) {
	    VL_WRITEF("[%0t] %%Error: StrongEnumFSMTester.v:261: Assertion failed in %NStrongEnumFSMTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StrongEnumFSMTester/2020030622451917629993952480544757/StrongEnumFSMTester.v",261,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->StrongEnumFSMTester__DOT___T_8) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StrongEnumFSMTester/2020030622451917629993952480544757/StrongEnumFSMTester.v",272,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/StrongEnumFSMTester/2020030622451917629993952480544757/StrongEnumFSMTester.v:58
