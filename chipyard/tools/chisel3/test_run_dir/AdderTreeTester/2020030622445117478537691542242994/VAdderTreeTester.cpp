...
VL_INLINE_OPT void VAdderTreeTester::_sequent__TOP__1(VAdderTreeTester__Syms* __restrict vlSymsp) {
    ...
    VAdderTreeTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/AdderTreeTester/2020030622445117478537691542242994/AdderTreeTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/AdderTreeTester/2020030622445117478537691542242994/AdderTreeTester.v",13,"");
	}
    }
}
