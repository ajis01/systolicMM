...
VL_INLINE_OPT void VWidthTester::_sequent__TOP__1(VWidthTester__Syms* __restrict vlSymsp) {
    ...
    VWidthTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WidthTester/202003062245129605781363298546753/WidthTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/WidthTester/202003062245129605781363298546753/WidthTester.v",13,"");
	}
    }
}
