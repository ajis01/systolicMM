...
VL_INLINE_OPT void VRecordQueueTester::_sequent__TOP__1(VRecordQueueTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v:119
    if (vlTOPp->reset) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v:235
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->RecordQueueTester__DOT___T_4) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v",257,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->RecordQueueTester__DOT___T_4) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->RecordQueueTester__DOT___T_4) 
	    ...
	    VL_WRITEF("[%0t] %%Error: RecordQueueTester.v:279: Assertion failed in %NRecordQueueTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v",279,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->RecordQueueTester__DOT___T_4) 
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->RecordQueueTester__DOT___T_4) 
	    ...
	    VL_WRITEF("[%0t] %%Error: RecordQueueTester.v:301: Assertion failed in %NRecordQueueTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v",301,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->RecordQueueTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v",312,"");
	}
    }
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v:123
    ...
    // ALWAYSPOST at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RecordQueueTester/2020030622465611018562774446183850/RecordQueueTester.v:120
