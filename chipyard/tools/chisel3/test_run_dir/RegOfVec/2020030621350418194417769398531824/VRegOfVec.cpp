...
VL_INLINE_OPT void VRegOfVec::_sequent__TOP__1(VRegOfVec__Syms* __restrict vlSymsp) {
    ...
    VRegOfVec* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RegOfVec/2020030621350418194417769398531824/RegOfVec.v:49
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->RegOfVec__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/RegOfVec/2020030621350418194417769398531824/RegOfVec.v",64,"");
	}
    }
