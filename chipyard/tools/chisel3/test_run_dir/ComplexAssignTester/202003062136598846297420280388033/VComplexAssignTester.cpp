...
VL_INLINE_OPT void VComplexAssignTester::_sequent__TOP__1(VComplexAssignTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ComplexAssignTester/202003062136598846297420280388033/ComplexAssignTester.v:79
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->ComplexAssignTester__DOT__value) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ComplexAssignTester/202003062136598846297420280388033/ComplexAssignTester.v",112,"");
	}
    }
