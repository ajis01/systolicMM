...
VL_INLINE_OPT void V_4::_sequent__TOP__1(V_4__Syms* __restrict vlSymsp) {
    ...
    V_4* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_4/202003062134146725496474388349696/_4.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/_4/202003062134146725496474388349696/_4.v",13,"");
	}
    }
}
