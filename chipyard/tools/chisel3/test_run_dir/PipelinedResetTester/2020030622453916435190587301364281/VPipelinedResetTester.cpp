...
VL_INLINE_OPT void VPipelinedResetTester::_sequent__TOP__1(VPipelinedResetTester__Syms* __restrict vlSymsp) {
    ...
    VPipelinedResetTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PipelinedResetTester/2020030622453916435190587301364281/PipelinedResetTester.v:51
    if (vlTOPp->reset) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->PipelinedResetTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/PipelinedResetTester/2020030622453916435190587301364281/PipelinedResetTester.v",64,"");
	}
    }
