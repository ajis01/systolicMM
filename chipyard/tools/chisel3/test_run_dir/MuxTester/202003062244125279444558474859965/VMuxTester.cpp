...
VL_INLINE_OPT void VMuxTester::_sequent__TOP__1(VMuxTester__Syms* __restrict vlSymsp) {
    ...
    VMuxTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MuxTester/202003062244125279444558474859965/MuxTester.v:7
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/MuxTester/202003062244125279444558474859965/MuxTester.v",13,"");
	}
    }
}
