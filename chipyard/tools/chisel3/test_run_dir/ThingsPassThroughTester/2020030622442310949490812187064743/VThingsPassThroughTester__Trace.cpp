...
void VThingsPassThroughTester::traceChgThis__3(VThingsPassThroughTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+5,(((0x13U != (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)) 
								 ...
								 | ((6U 
									...
									!= (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)) 
									  ...
									  | ((3U 
										...
										| (1U 
										== (IData)(vlTOPp->ThingsPassThroughTester__DOT__value))))))))))))))))))))));
	vcdp->chgBit  (c+6,(((2U >= (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__value_1)) 
	...
	vcdp->chgBit  (c+27,((2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__value))));
	vcdp->chgBit  (c+28,((2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__value_1))));
    }
}
