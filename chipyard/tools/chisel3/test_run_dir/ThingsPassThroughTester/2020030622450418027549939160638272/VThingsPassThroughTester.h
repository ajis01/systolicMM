...
VL_MODULE(VThingsPassThroughTester) {
  public:
    ...
    VL_SIG8(ThingsPassThroughTester__DOT__q__DOT__value,0,0);
    VL_SIG8(ThingsPassThroughTester__DOT__q__DOT__value_1,0,0);
    ...
    VL_SIG8(ThingsPassThroughTester__DOT__q__DOT___T_12,0,0);
    VL_SIG8(ThingsPassThroughTester__DOT__q__DOT___T_14,0,0);
    ...
    VL_SIG8(ThingsPassThroughTester__DOT__q__DOT___T[2],2,0);
