...
void VThingsPassThroughTester::traceChgThis__2(VThingsPassThroughTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+1,((1U & ((IData)(vlTOPp->ThingsPassThroughTester__DOT___T_15) 
				   >> 9U))));
    }
}
...
void VThingsPassThroughTester::traceChgThis__3(VThingsPassThroughTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+2,((1U & (~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT___T_1)))));
	vcdp->chgBit  (c+3,((0x14U > (IData)(vlTOPp->ThingsPassThroughTester__DOT__value))));
	vcdp->chgBus  (c+4,(((0x13U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value))
							   ...
							   ((7U 
								...
								((2U 
								 ...
								 ((1U 
								   ...
								   ? 4U
								   : 7U)))))))))))))))))))),3);
	vcdp->chgBit  (c+5,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT___T_1));
