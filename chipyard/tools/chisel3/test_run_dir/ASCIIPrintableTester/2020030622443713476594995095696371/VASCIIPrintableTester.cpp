...
VL_INLINE_OPT void VASCIIPrintableTester::_sequent__TOP__1(VASCIIPrintableTester__Syms* __restrict vlSymsp) {
    ...
    VASCIIPrintableTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ASCIIPrintableTester/2020030622443713476594995095696371/ASCIIPrintableTester.v:7
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ASCIIPrintableTester/2020030622443713476594995095696371/ASCIIPrintableTester.v",24,"");
	}
    }
}
