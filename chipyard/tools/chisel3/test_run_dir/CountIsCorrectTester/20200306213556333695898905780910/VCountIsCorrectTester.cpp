...
VL_INLINE_OPT void VCountIsCorrectTester::_sequent__TOP__1(VCountIsCorrectTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/20200306213556333695898905780910/CountIsCorrectTester.v:61
    if (vlTOPp->reset) {
	vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_1 = 0U;
    } else {
	if (vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_11) {
	    vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_1 
		= vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_6;
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/20200306213556333695898905780910/CountIsCorrectTester.v:456
    if (vlTOPp->reset) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->CountIsCorrectTester__DOT___T_17) 
			 & (~ (IData)(vlTOPp->CountIsCorrectTester__DOT___T_25))))) {
	    VL_WRITEF("[%0t] %%Error: CountIsCorrectTester.v:495: Assertion failed in %NCountIsCorrectTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/20200306213556333695898905780910/CountIsCorrectTester.v",495,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->CountIsCorrectTester__DOT___T_27) 
			 & (~ (IData)(vlTOPp->CountIsCorrectTester__DOT___T_25))))) {
	    VL_WRITEF("[%0t] %%Error: CountIsCorrectTester.v:517: Assertion failed in %NCountIsCorrectTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/20200306213556333695898905780910/CountIsCorrectTester.v",517,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->CountIsCorrectTester__DOT___T_28) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/20200306213556333695898905780910/CountIsCorrectTester.v",528,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/20200306213556333695898905780910/CountIsCorrectTester.v:242
    __Vdly__CountIsCorrectTester__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
    ...
    vlTOPp->CountIsCorrectTester__DOT___T_20 = (0x1fU 
						& ((IData)(1U) 
						   + (IData)(vlTOPp->CountIsCorrectTester__DOT__value)));
    vlTOPp->CountIsCorrectTester__DOT___T_17 = ((~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_1)) 
						& (0x14U 
						   > (IData)(vlTOPp->CountIsCorrectTester__DOT__value)));
    vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_6 
    ...
    vlTOPp->CountIsCorrectTester__DOT___T_27 = (((IData)(vlTOPp->CountIsCorrectTester__DOT___T_15) 
						 >> 6U) 
						& (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_1));
    vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_11 
	= ((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_6) 
	   != (((IData)(vlTOPp->CountIsCorrectTester__DOT___T_15) 
		>> 6U) & (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_1)));
}
...
void VCountIsCorrectTester::_settle__TOP__2(VCountIsCorrectTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->CountIsCorrectTester__DOT___T_17 = ((~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_1)) 
						& (0x14U 
						   > (IData)(vlTOPp->CountIsCorrectTester__DOT__value)));
    vlTOPp->CountIsCorrectTester__DOT___T_25 = (((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_1) 
						 == 
						 (0x1fU 
						  & ((IData)(vlTOPp->CountIsCorrectTester__DOT__value) 
						     - (IData)(vlTOPp->CountIsCorrectTester__DOT__value_1)))) 
...
void VCountIsCorrectTester::_ctor_var_reset() {
    ...
    CountIsCorrectTester__DOT__q__DOT___T_11 = VL_RAND_RESET_I(1);
