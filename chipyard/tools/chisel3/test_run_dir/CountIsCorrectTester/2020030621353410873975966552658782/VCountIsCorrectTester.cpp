...
VL_INLINE_OPT void VCountIsCorrectTester::_sequent__TOP__1(VCountIsCorrectTester__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/2020030621353410873975966552658782/CountIsCorrectTester.v:498
    if (vlTOPp->reset) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->CountIsCorrectTester__DOT___T_17) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/2020030621353410873975966552658782/CountIsCorrectTester.v",537,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->CountIsCorrectTester__DOT___T_27) 
	    ...
	    VL_WRITEF("[%0t] %%Error: CountIsCorrectTester.v:559: Assertion failed in %NCountIsCorrectTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/2020030621353410873975966552658782/CountIsCorrectTester.v",559,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->CountIsCorrectTester__DOT___T_28) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/2020030621353410873975966552658782/CountIsCorrectTester.v",570,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/2020030621353410873975966552658782/CountIsCorrectTester.v:90
    if (vlTOPp->reset) {
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/CountIsCorrectTester/2020030621353410873975966552658782/CountIsCorrectTester.v:284
    __Vdly__CountIsCorrectTester__DOT__MaxPeriodFibonacciLFSR__DOT__state_0 
	...
	= (1U & (((IData)(vlTOPp->CountIsCorrectTester__DOT___T_15) 
		  >> 0xeU) & (~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_4))));
}
