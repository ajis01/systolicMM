...
VL_MODULE(VCountIsCorrectTester) {
  public:
    ...
    VL_SIG8(CountIsCorrectTester__DOT__q__DOT__value,1,0);
    VL_SIG8(CountIsCorrectTester__DOT__q__DOT__value_1,1,0);
    ...
    VL_SIG8(CountIsCorrectTester__DOT__q__DOT__wrap,0,0);
    VL_SIG8(CountIsCorrectTester__DOT__q__DOT___T_12,1,0);
    VL_SIG8(CountIsCorrectTester__DOT__q__DOT__wrap_1,0,0);
    VL_SIG8(CountIsCorrectTester__DOT__q__DOT___T_14,1,0);
    VL_SIG8(CountIsCorrectTester__DOT__q__DOT___T_20,1,0);
