...
void VCountIsCorrectTester::traceChgThis__2(VCountIsCorrectTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus  (c+4,((3U & ((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT___T_2)
...
void VCountIsCorrectTester::traceChgThis__3(VCountIsCorrectTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus  (c+24,(vlTOPp->CountIsCorrectTester__DOT__q__DOT__value),2);
	vcdp->chgBus  (c+25,(vlTOPp->CountIsCorrectTester__DOT__q__DOT__value_1),2);
	vcdp->chgBit  (c+26,((2U == (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__value))));
	vcdp->chgBit  (c+27,((2U == (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__value_1))));
    }
}
