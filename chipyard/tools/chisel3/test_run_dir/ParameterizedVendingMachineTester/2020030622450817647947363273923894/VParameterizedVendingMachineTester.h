...
VL_MODULE(VParameterizedVendingMachineTester) {
  public:
    ...
    VL_SIG8(ParameterizedVendingMachineTester__DOT___GEN_101,3,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT___T_13,0,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT__dut__DOT___T_19,0,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT__dut__DOT__value,7,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT__dut__DOT__doDispense,0,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT__dut__DOT___T_33,7,0);
