...
void VParameterizedVendingMachineTester::traceChgThis__2(VParameterizedVendingMachineTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+2,((1U & ((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_101) 
				   >> 1U))));
	vcdp->chgBus  (c+3,(((2U & (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_101))
...
void VParameterizedVendingMachineTester::traceChgThis__3(VParameterizedVendingMachineTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+4,((0x1edU <= (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value))));
	vcdp->chgBus  (c+5,(vlTOPp->ParameterizedVendingMachineTester__DOT__value),7);
	vcdp->chgBit  (c+6,((0x64U == (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__value))));
	vcdp->chgBus  (c+7,(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value),10);
    }
}
