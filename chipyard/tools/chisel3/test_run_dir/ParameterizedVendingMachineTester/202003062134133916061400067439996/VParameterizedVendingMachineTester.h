...
VL_MODULE(VParameterizedVendingMachineTester) {
  public:
    ...
    VL_SIG8(ParameterizedVendingMachineTester__DOT___T_10,0,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT__dut__DOT__value,2,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT__dut__DOT__doDispense,0,0);
    VL_SIG8(ParameterizedVendingMachineTester__DOT__dut__DOT___T_1,2,0);
