...
#ifndef _VParameterizedVendingMachineTester__Syms_H_
#define _VParameterizedVendingMachineTester__Syms_H_
...
class VParameterizedVendingMachineTester__Syms : public VerilatedSyms {
  public:
    ...
    // CREATORS
    VParameterizedVendingMachineTester__Syms(VParameterizedVendingMachineTester* topp, const char* namep);
