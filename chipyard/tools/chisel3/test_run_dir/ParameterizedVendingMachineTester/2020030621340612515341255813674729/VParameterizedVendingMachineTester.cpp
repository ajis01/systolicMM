...
VL_INLINE_OPT void VParameterizedVendingMachineTester::_sequent__TOP__1(VParameterizedVendingMachineTester__Syms* __restrict vlSymsp) {
    ...
    VParameterizedVendingMachineTester* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v:71
	...
	if (VL_UNLIKELY((1U & ((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_101) 
	    ...
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v",95,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_101) 
	...
	if (VL_UNLIKELY((1U & (((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_101) 
	    ...
	    VL_WRITEF("[%0t] %%Error: ParameterizedVendingMachineTester.v:117: Assertion failed in %NParameterizedVendingMachineTester.dut\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v",117,"");
	}
    }
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v:71
    ...
    // ALWAYS at /home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v:605
	...
	if (VL_UNLIKELY(((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v",620,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY(((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__done) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v",631,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___T_11))))) {
	    VL_WRITEF("[%0t] %%Error: ParameterizedVendingMachineTester.v:653: Assertion failed in %NParameterizedVendingMachineTester\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/ajis01/scratch/CS252A_Project/chipyard/tools/chisel3/test_run_dir/ParameterizedVendingMachineTester/2020030621340612515341255813674729/ParameterizedVendingMachineTester.v",653,"");
	}
    }
