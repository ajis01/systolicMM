...
void VParameterizedVendingMachineTester::traceChgThis__3(VParameterizedVendingMachineTester__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+4,((4U <= (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value))));
	...
	vcdp->chgBus  (c+7,(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value),3);
    }
}
