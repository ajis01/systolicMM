...
inline bool AstNode::privateIsLogEq(const AstNode* nodep) { return nodep && nodep->type() == AstType::atLogEq; }
...
inline AstLogEq* AstNode::privateCastLogEq(AstNode* nodep) { return dynamic_cast<AstLogEq*>(nodep); }
...
inline const AstLogEq* AstNode::privateConstCastLogEq(const AstNode* nodep) { return dynamic_cast<const AstLogEq*>(nodep); }
