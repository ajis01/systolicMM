...
VL_MODULE(dut) {
  public:
    ...
    VL_SIG8(ValExec_RecF16ToRecF32__DOT___T_23,3,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT___T_32,5,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT___T_33,0,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT___T_104,4,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT___T_114,0,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT___T_143,0,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT__recFNToRecFN__DOT__RoundAnyRawFNToRecFN_io_invalidExc,0,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT__recFNToRecFN__DOT__RoundAnyRawFNToRecFN_io_in_isInf,0,0);
    VL_SIG8(ValExec_RecF16ToRecF32__DOT__recFNToRecFN__DOT__RoundAnyRawFNToRecFN__DOT__isNaNOut,0,0);
    VL_SIG16(ValExec_RecF16ToRecF32__DOT___T_113,8,0);
    VL_SIG(ValExec_RecF16ToRecF32__DOT__recFNToRecFN_io_in,16,0);
