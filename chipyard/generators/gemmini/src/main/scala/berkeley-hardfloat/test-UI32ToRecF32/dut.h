...
VL_MODULE(dut) {
  public:
    ...
    VL_SIG8(ValExec_UI32ToRecF32__DOT___T_49,4,0);
    VL_SIG8(ValExec_UI32ToRecF32__DOT___T_59,0,0);
    VL_SIG8(ValExec_UI32ToRecF32__DOT___T_88,0,0);
    VL_SIG8(ValExec_UI32ToRecF32__DOT__iNToRecFN__DOT___T_69,4,0);
    VL_SIG8(ValExec_UI32ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__common_inexact,0,0);
    VL_SIG16(ValExec_UI32ToRecF32__DOT___T_58,8,0);
    VL_SIG(ValExec_UI32ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__adjustedSig,26,0);
    VL_SIG(ValExec_UI32ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT___T_40,25,0);
    VL_SIG64(ValExec_UI32ToRecF32__DOT__iNToRecFN__DOT___T_70,62,0);
