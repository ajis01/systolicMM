...
VL_MODULE(dut) {
  public:
    ...
    VL_SIG8(ValExec_f16FromRecF16__DOT___T_23,3,0);
    VL_SIG8(ValExec_f16FromRecF16__DOT___T_32,5,0);
    VL_SIG8(ValExec_f16FromRecF16__DOT___T_33,0,0);
    VL_SIG8(ValExec_f16FromRecF16__DOT___T_65,0,0);
    VL_SIG16(ValExec_f16FromRecF16__DOT___T_71,11,0);
    VL_SIG(ValExec_f16FromRecF16__DOT___T_54,16,0);
