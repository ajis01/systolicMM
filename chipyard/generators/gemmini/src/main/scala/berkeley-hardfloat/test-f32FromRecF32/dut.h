...
VL_MODULE(dut) {
  public:
    ...
    VL_SIG8(ValExec_f32FromRecF32__DOT___T_49,4,0);
    VL_SIG8(ValExec_f32FromRecF32__DOT___T_59,0,0);
    VL_SIG8(ValExec_f32FromRecF32__DOT___T_91,0,0);
    VL_SIG16(ValExec_f32FromRecF32__DOT___T_58,8,0);
    VL_SIG(ValExec_f32FromRecF32__DOT___T_97,24,0);
    VL_SIG64(ValExec_f32FromRecF32__DOT___T_80,32,0);
