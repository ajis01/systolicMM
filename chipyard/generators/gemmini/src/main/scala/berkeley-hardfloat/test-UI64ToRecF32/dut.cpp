...
void dut::_initial__TOP__1(dut__Syms* __restrict vlSymsp) {
    ...
    dut* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // INITIAL at test-UI64ToRecF32/ValExec_UI64ToRecF32.v:396
    vlTOPp->io_check = 1U;
}
...
VL_INLINE_OPT void dut::_combo__TOP__2(dut__Syms* __restrict vlSymsp) {
    ...
    // Body
    vlTOPp->ValExec_UI64ToRecF32__DOT___T_59 = ((0U 
						 == 
						 (0xffU 
						...
						& (0U 
						   ...
						   (0x7fffffU 
						    & vlTOPp->io_expected_out)));
    vlTOPp->ValExec_UI64ToRecF32__DOT___T_49 = ((0x400000U 
						 & vlTOPp->io_expected_out)
						 ? 0U
						 : 
						((0x200000U 
    ...
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_133 
									  ...
									  ((8U 
									   ...
									   ((4U 
										...
										& __Vtemp63[0U])
										 ? 0x3eU
										 : 0x3fU)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
    vlTOPp->ValExec_UI64ToRecF32__DOT___T_58 = (0x1ffU 
						& (((0U 
						     == 
						     (0xffU 
						      & (vlTOPp->io_expected_out 
							 >> 0x17U)))
						     ? 
						    (~ (IData)(vlTOPp->ValExec_UI64ToRecF32__DOT___T_49))
						     : 
						    (0xffU 
						     & (vlTOPp->io_expected_out 
							>> 0x17U))) 
    ...
    VL_SHIFTL_WWI(127,127,6, __Vtemp66, __Vtemp65, (IData)(vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_133));
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_134[0U] 
	= __Vtemp66[0U];
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_134[1U] 
	= __Vtemp66[1U];
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_134[2U] 
	= __Vtemp66[2U];
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_134[3U] 
    ...
    vlTOPp->io_expected_recOut = (((QData)((IData)(
						   ((8U 
							...
							>> 0x1cU)) 
						    | (7U 
						       & (((IData)(vlTOPp->ValExec_UI64ToRecF32__DOT___T_59)
							    ? 0U
							    : 
							   ((IData)(vlTOPp->ValExec_UI64ToRecF32__DOT___T_58) 
							    >> 6U)) 
							  | ((3U 
							      == 
							      (3U 
    ...
    VL_EXTEND_WQ(65,64, __Vtemp69, (((QData)((IData)(
				     ...
				     << 0x20U) | (QData)((IData)(
								 vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_134[0U]))));
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__adjustedSig 
	= ((0x7fffffeU & ((__Vtemp68[2U] << 0x1aU) 
	   ...
	   | (VL_ULL(0) != (VL_ULL(0x7fffffffff) & 
			    (((QData)((IData)(__Vtemp69[1U])) 
			      << 0x20U) | (QData)((IData)(
							  __Vtemp69[0U]))))));
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__common_inexact 
	= ((0U != (2U & vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__adjustedSig)) 
	   | (0U != (1U & vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__adjustedSig)));
    vlTOPp->io_actual_exceptionFlags = ((vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_134[1U] 
					 >> 0x1fU) 
					& (IData)(vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__common_inexact));
    vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT___T_40 
	= (0x3ffffffU & (((((0U == (IData)(vlTOPp->io_roundingMode)) 
			  ...
			  ? (((IData)(1U) + (0x1ffffffU 
			     ...
			     & (~ ((((0U == (IData)(vlTOPp->io_roundingMode)) 
				    ...
				    & (0U == (1U & vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__adjustedSig)))
				    ? 1U : 0U))) : 
			 ((0x1ffffffU & (vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__adjustedSig 
					 >> 2U)) | 
						    ...
						    & VL_EXTENDS_II(11,10, 
									...
									(0x3ffU 
									 & VL_EXTENDS_II(10,9, 
										(0x80U 
										| (0x3fU 
										& (~ (IData)(vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_133)))))))))) 
						   + 
						   (0x7ffU 
						    & VL_EXTENDS_II(11,10, 
								    (3U 
			      ...
			      << 0x17U) | (QData)((IData)(
							  (0x7fffffU 
							   & ((0x80000000U 
							       ...
							       ? vlTOPp->ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT___T_40
							       : 0U)))));
    vlTOPp->ValExec_UI64ToRecF32__DOT___T_88 = ((0xfU 
						 & (IData)(
    ...
    vlTOPp->io_pass = ((((0U == (7U & (IData)((vlTOPp->io_actual_out 
			 ...
			 | (7U == (7U & (IData)((vlTOPp->io_actual_out 
						 >> 0x1dU)))))
			 ? ((IData)(vlTOPp->ValExec_UI64ToRecF32__DOT___T_88) 
...
void dut::_ctor_var_reset() {
    ...
    ValExec_UI64ToRecF32__DOT___T_49 = VL_RAND_RESET_I(5);
    ValExec_UI64ToRecF32__DOT___T_58 = VL_RAND_RESET_I(9);
    ValExec_UI64ToRecF32__DOT___T_59 = VL_RAND_RESET_I(1);
    ValExec_UI64ToRecF32__DOT___T_88 = VL_RAND_RESET_I(1);
    ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_133 = VL_RAND_RESET_I(6);
    VL_RAND_RESET_W(127,ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT___T_134);
    ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__adjustedSig = VL_RAND_RESET_I(27);
    ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT__common_inexact = VL_RAND_RESET_I(1);
    ValExec_UI64ToRecF32__DOT__iNToRecFN__DOT__roundAnyRawFNToRecFN__DOT___T_40 = VL_RAND_RESET_I(26);
}
