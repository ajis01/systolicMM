...
VL_MODULE(dut) {
  public:
    ...
    VL_SIG8(ValExec_RecF16ToRecF64__DOT___T_23,3,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT___T_32,5,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT___T_33,0,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT___T_162,5,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT___T_172,0,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT___T_201,0,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT__recFNToRecFN__DOT__RoundAnyRawFNToRecFN_io_invalidExc,0,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT__recFNToRecFN__DOT__RoundAnyRawFNToRecFN_io_in_isInf,0,0);
    VL_SIG8(ValExec_RecF16ToRecF64__DOT__recFNToRecFN__DOT__RoundAnyRawFNToRecFN__DOT__isNaNOut,0,0);
    VL_SIG16(ValExec_RecF16ToRecF64__DOT___T_171,11,0);
    VL_SIG(ValExec_RecF16ToRecF64__DOT__recFNToRecFN_io_in,16,0);
