...
VL_MODULE(dut) {
  public:
    ...
    VL_SIG8(ValExec_CompareRecF16_eq__DOT___T_23,3,0);
    VL_SIG8(ValExec_CompareRecF16_eq__DOT___T_32,5,0);
    VL_SIG8(ValExec_CompareRecF16_eq__DOT___T_33,0,0);
    VL_SIG8(ValExec_CompareRecF16_eq__DOT___T_78,3,0);
    VL_SIG8(ValExec_CompareRecF16_eq__DOT___T_87,5,0);
    VL_SIG8(ValExec_CompareRecF16_eq__DOT___T_88,0,0);
    VL_SIG8(ValExec_CompareRecF16_eq__DOT__compareRecFN__DOT__rawA_isNaN,0,0);
    VL_SIG8(ValExec_CompareRecF16_eq__DOT__compareRecFN__DOT__rawB_isNaN,0,0);
    VL_SIG16(ValExec_CompareRecF16_eq__DOT__compareRecFN__DOT__rawA_sig,11,0);
    VL_SIG16(ValExec_CompareRecF16_eq__DOT__compareRecFN__DOT__rawB_sig,11,0);
    VL_SIG(ValExec_CompareRecF16_eq__DOT__compareRecFN_io_a,16,0);
    VL_SIG(ValExec_CompareRecF16_eq__DOT__compareRecFN_io_b,16,0);
